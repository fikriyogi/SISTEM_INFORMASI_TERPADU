!function(t, e) {
    ...
    , function(t, e, n) {
        ...
        d.default)("quill")
          , _ = function() {
            ...
            return i(t, null, [{
                ...
                key: "import",
                value: function(t) {
                    return null == this.imports[t] && m.error("Cannot import " + t + ". Are you sure it was registered?"),
                    this.imports[t]
                }
            }, {
                key: "register",
                value: function(t, e) {
                    ...
                    if ("string" != typeof t) {
                        ...
                        null == this.imports[t] || r || m.warn("Overwriting " + t + " with", e),
                        this.imports[t] = e,
            ...
            i(t, [{
                ...
                value: function(t, e, n, r, i) {
                    var l, a = this, s = x(t, e, n, r, i), u = o(s, 4);
                    return t = u[0],
                    e = u[1],
                    l = u[2],
                    i = u[3],
                ...
                key: "insertText",
                value: function(t, e, n, r, i) {
                    var l, a = this, s = x(t, 0, n, r, i), u = o(s, 4);
                    return t = u[0],
                    l = u[2],
                    i = u[3],
                    w.call(this, (function() {
        ...
        function O(t, e) {
            ...
            p.default)(!0, {
                ...
                if (e.theme = _.import("themes/" + e.theme),
                null == e.theme)
            ...
            var r = Object.keys(n.modules).concat(Object.keys(e.modules)).reduce((function(t, e) {
                ...
                return null == n ? m.error("Cannot load " + e + " module. Are you sure you registered it?") : t[e] = n.DEFAULTS || {},
                t
            }
            ), {});
        ...
        function w(t, e, n, r) {
            ...
            null == r ? o = k(o, a, e) : 0 !== r && (o = k(o, n, r, e)),
            this.setSelection(o, s.default.sources.SILENT)),
            a.length() > 0) {
                var u, c, f = [s.default.events.TEXT_CHANGE, a, i, e];
                if ((u = this.emitter).emit.apply(u, [s.default.events.EDITOR_CHANGE].concat(f)),
            ...
            return o(t, [{
                ...
                value: function() {
                    ...
                    a.default)(e, this.lastRange)) {
                        ...
                        l.default)(e), t];
                        if ((c = this.emitter).emit.apply(c, [s.default.events.EDITOR_CHANGE].concat(h)),
                ...
                value: function() {
                    if (!this.selection.composing && null != this.parent) {
                        ...
                        if (this.textNode.data !== e.CONTENTS) {
                            ...
                            this.next instanceof a.default ? (o = this.next.domNode,
            ...
            r(e, [{
                ...
                value: function(t) {
                    ...
                    if (t === this.leftGuard)
                        ...
                        t === this.rightGuard && (this.next instanceof i.default ? (this.next.insertAt(0, r),
                        e = {
    ...
    , function(t, e, n) {
                ...
                value: function(t, e) {
                    ...
                    this.pickers = t.map((function(t) {
                        if (t.classList.contains("ql-align"))
                            return null == t.querySelector("option") && k(t, b),
                        ...
                        if (t.classList.contains("ql-background") || t.classList.contains("ql-color")) {
                            ...
                            return null == t.querySelector("option") && k(t, g, "background" === n ? "#ffffff" : "#000000"),
                            new u.default(t,e[n])
                        }
                        return null == t.querySelector("option") && (t.classList.contains("ql-font") ? k(t, m) : t.classList.contains("ql-header") ? k(t, _) : t.classList.contains("ql-size") && k(t, O)),
                        new f.default(t)
                    }
                    ));
        ...
        w.DEFAULTS = (0,
        o.default)(!0, {}, s.default.DEFAULTS, {
            modules: {
                toolbar: {
                    handlers: {
                        formula: function() {
            ...
            r(e, [{
                ...
                value: function() {
                    ...
                    this.textbox.addEventListener("keydown", (function(e) {
                        a.default.match(e, "enter") ? (t.save(),
                        e.preventDefault()) : a.default.match(e, "escape") && (t.cancel(),
                        e.preventDefault())
                    }
                    ))
                }
                ...
                value: function() {
                    ...
                    case "link":
                        ...
                        this.linkRange ? (this.quill.formatText(this.linkRange, "link", t, l.default.sources.USER),
                    ...
                    case "formula":
                        ...
                        if (null != n) {
                            ...
                            this.quill.setSelection(r + 2, l.default.sources.USER)
                        }
                    }
                    this.textbox.value = "",
                    this.hide()
    ...
    , function(t, e) {
        function n(t, e, l) {
            ...
            var c = t.substring(t.length - s)
              , f = function(t, e) {
                ...
                var a = t.length > e.length ? t : e
                  ...
                  , u = a.indexOf(s);
                if (-1 != u)
                    return l = [[1, a.substring(0, u)], [0, s], [1, a.substring(u + s.length)]],
                    t.length > e.length && (l[0][0] = l[2][0] = -1),
                    l;
                if (1 == s.length)
                    return [[-1, t], [1, e]];
                var c = function(t, e) {
                    ...
                    var a, s, u, c, f, h = l(n, r, Math.ceil(n.length / 4)), p = l(n, r, Math.ceil(n.length / 2));
                    if (!h && !p)
                        return null;
                ...
                return function(t, e) {
                    ...
                    for (var f = n - o, h = f % 2 != 0, p = 0, d = 0, y = 0, v = 0, b = 0; b < i; b++) {
                        for (var g = -b + p; g <= b - d; g += 2) {
                            for (var m = l + g, _ = (E = g == -b || g != b && s[m - 1] < s[m + 1] ? s[m + 1] : s[m - 1] + 1) - g; E < n && _ < o && t.charAt(E) == e.charAt(_); )
                                E++,
                                _++;
                            if (s[m] = E,
                            E > n)
                        ...
                        for (var w = -b + y; w <= b - v; w += 2) {
                            for (var x = l + w, k = (O = w == -b || w != b && u[x - 1] < u[x + 1] ? u[x + 1] : u[x - 1] + 1) - w; O < n && k < o && t.charAt(n - O - 1) == e.charAt(o - k - 1); )
                                O++,
                                k++;
                            if (u[x] = O,
                            O > n)
            ...
            return u && f.unshift([0, u]),
            c && f.push([0, c]),
            function t(e) {
                e.push([0, ""]);
                var n, r = 0, l = 0, a = 0, s = "", u = "";
                for (; r < e.length; )
                    switch (e[r][0]) {
                    case 1:
                        a++,
                    ...
                    case -1:
                        ...
                        break;
                    case 0:
                        l + a > 1 ? (0 !== l && 0 !== a && (0 !== (n = o(u, s)) && (r - l - a > 0 && 0 == e[r - l - a - 1][0] ? e[r - l - a - 1][1] += u.substring(0, n) : (e.splice(0, 0, [0, u.substring(0, n)]),
                        r++),
                        u = u.substring(n),
                        s = s.substring(n)),
                        0 !== (n = i(u, s)) && (e[r][1] = u.substring(u.length - n) + e[r][1],
                        u = u.substring(0, u.length - n),
                        s = s.substring(0, s.length - n))),
                        0 === l ? e.splice(r - a, l + a, [1, u]) : 0 === a ? e.splice(r - l, l + a, [-1, s]) : e.splice(r - l - a, l + a, [-1, s], [1, u]),
                        r = r - l - a + (l ? 1 : 0) + (a ? 1 : 0) + 1) : 0 !== r && 0 == e[r - 1][0] ? (e[r - 1][1] += e[r][1],
                        e.splice(r, 1)) : r++,
                        a = 0,
                        l = 0,
                        s = "",
                ...
                r = 1;
                for (; r < e.length - 1; )
                    0 == e[r - 1][0] && 0 == e[r + 1][0] && (e[r][1].substring(e[r][1].length - e[r - 1][1].length) == e[r - 1][1] ? (e[r][1] = e[r - 1][1] + e[r][1].substring(0, e[r][1].length - e[r - 1][1].length),
                    e[r + 1][1] = e[r - 1][1] + e[r + 1][1],
                    e.splice(r - 1, 1),
                    c = !0) : e[r][1].substring(0, e[r + 1][1].length) == e[r + 1][1] && (e[r - 1][1] += e[r + 1][1],
            ...
            f = function(t) {
                for (var e = !1, n = function(t) {
                    ...
                    0 === t[r - 2][0] && ((o = t[r - 2][1]).charCodeAt(o.length - 1) >= 55296 && o.charCodeAt(o.length - 1) <= 56319) && -1 === t[r - 1][0] && n(t[r - 1][1]) && 1 === t[r][0] && n(t[r][1]) && (e = !0,
    ...
    , function(t, e, n) {
        ...
        c.default)("quill:clipboard")
          , w = "__ql-matcher"
          , x = [[Node.TEXT_NODE, R], [Node.TEXT_NODE, L], ["br", function(t, e) {
            q(e, "\n") || e.insert("\n");
            return e
        }
        ], [Node.ELEMENT_NODE, L], [Node.ELEMENT_NODE, C], [Node.ELEMENT_NODE, M], [Node.ELEMENT_NODE, S], [Node.ELEMENT_NODE, function(t, e) {
            var n = {}
              , r = t.style || {};
        ...
        ], ["b", P.bind(P, "bold")], ["i", P.bind(P, "italic")], ["style", function() {
    ...
    , function(t, e, n) {
        ...
        g.DEFAULTS = (0,
        l.default)(!0, {}, u.default.DEFAULTS, {
            modules: {
                toolbar: {
                    handlers: {
                        link: function(t) {
                        ...
                        if (null != e) {
                            if (0 === e.length && o === a.default.sources.USER) {
                                ...
                                if (null != s) {
                                    ...
                                    return t.preview.textContent = h,
        ...
        m.TEMPLATE = ['<a class="ql-preview" rel="noopener noreferrer" target="_blank" href="about:blank"></a>', '<input type="text" data-formula="e=mc^2" data-link="https://quilljs.com" data-video="Embed URL">', '<a class="ql-action"></a>', '<a class="ql-remove"></a>'].join(""),
        e.default = g
    }
    , function(t, e, n) {
        "use strict";
          ...
          , p = function(t) {
            function e(t, n) {
                ...
                if ("function" != typeof r.options.highlight)
                    throw new Error("Syntax module requires highlight.js. Please inc the library on the page before Quill.");
                var o = null;
