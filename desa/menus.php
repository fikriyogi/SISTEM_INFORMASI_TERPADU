        ...
        <div class="nk-sidebar-inner" data-simplebar>
            <div class="nk-menu-content menu-active" data-content="navHospital">
                ...
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item">
                        <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/hom_sid">
                            <i class="fa fa-home"></i><span>Home</span>
                            <span class="pull-right-container"></span>
                        </a>
                    </li>
                    <li class="nk-menu-item has-sub">
                        <a class="nk-menu-link nk-menu-toggle" data-target="" href="https://demo.opensid.or.id/">
                            <i class="fa fa-dashboard"></i><span>Info Desa</span>
                            <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                        </a>
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/identitas_desa">
                                    <i class="fa fa-id-card"></i>
                                    Identitas Desa
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/sid_core/clear">
                                    <i class="fa fa-map"></i>
                                    Wilayah Administratif
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/pengurus/clear">
                                    <i class="fa fa-sitemap"></i>
                                    Pemerintahan Desa
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/status_desa">
                                    <i class="fa fa-dot-circle-o"></i>
                                    Status Desa
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/pelanggan">
                                    <i class="fa fa-credit-card"></i>
                                    Layanan Pelanggan
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/pendaftaran_kerjasama">
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/penduduk/clear">
                                    <i class="fa fa-user"></i>
                                    Penduduk
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/keluarga/clear">
                                    <i class="fa fa-users"></i>
                                    Keluarga
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/rtm/clear">
                                    <i class="fa fa-venus-mars"></i>
                                    Rumah Tangga
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/kelompok/clear">
                                    <i class="fa fa-sitemap"></i>
                                    Kelompok
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/suplemen/clear">
                                    <i class="fa fa-slideshare"></i>
                                    Data Suplemen
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/dpt/clear">
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/statistik/clear">
                                    <i class="fa fa-bar-chart"></i>
                                    Statistik Kependudukan
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/laporan/clear">
                                    <i class="fa fa-file-text"></i>
                                    Laporan Bulanan
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/laporan_rentan/clear">
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a class="nk-menu-link nk-menu-toggle" data-target="" href="https://demo.opensid.or.id/surat_master/clear">
                                    <i class="fa fa-cog"></i>
                                    Pengaturan Surat
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/surat">
                                    <i class="fa fa-files-o"></i>
                                    Cetak Surat
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/keluar/clear">
                                    <i class="fa fa-folder-open"></i>
                                    Arsip Layanan
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/surat/panduan">
                                    <i class="fa fa fa-book"></i>
                                    Panduan
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/surat_mohon">
                                    <i class="fa fa fa-book"></i>
                                    Daftar Persyaratan
                                </a>
                            </li>
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/dokumen/clear">
                                    <i class="fa fa-file-text"></i>
                                    Informasi Publik
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/inventaris_tanah">
                                    <i class="fa fa-cubes"></i>
                                    Inventaris
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/klasifikasi/clear">
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/bumindes_umum">
                                    <i class="fa fa-bookmark"></i>
                                    Administrasi Umum
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/bumindes_penduduk_induk/clear">
                                    <i class="fa fa-users"></i>
                                    Administrasi Penduduk
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/bumindes_keuangan">
                                    <i class="fa fa-money"></i>
                                    Administrasi Keuangan
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/bumindes_tanah_desa/clear">
                                    <i class="fa fa-university"></i>
                                    Administrasi Pembangunan
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/bumindes_lain">
                    ...
                    <li class="nk-menu-item has-sub active menu-open">
                        <a class="nk-menu-link nk-menu-toggle" data-target="" href="https://demo.opensid.or.id/">
                            <i class="fa fa-balance-scale text-aqua"></i><span>Keuangan</span>
                            <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                        </a>
                        <ul class="nk-menu-sub active">
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/keuangan/impor_data">
                                    <i class="fa fa-cloud-upload"></i>
                                    Impor Data
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/keuangan/laporan">
                                    <i class="fa fa-bar-chart"></i>
                                    Laporan
                                </a>
                            </li>
                            <li class="active">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/keuangan_manual/manual_apbdes">
                                    <i class="fa fa-keyboard-o text-red"></i>
                                    Input Data
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/keuangan_manual/laporan_manual">
                                    <i class="fa fa-bar-chart"></i>
                                    Laporan Manual
                                </a>
                            </li>
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/analisis_master/clear">
                                    <i class="fa fa-check-square-o"></i>
                                    Master Analisis
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/setting/analisis">
                    ...
                    <li class="nk-menu-item">
                        <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/program_bantuan/clear">
                            <i class="fa fa-heart"></i><span>Bantuan</span>
                            <span class="pull-right-container"></span>
                        </a>
                    </li>
                    <li class="nk-menu-item">
                        <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/cdesa/clear">
                            <i class="fa fa-map-signs"></i><span>Pertanahan</span>
                            <span class="pull-right-container"></span>
                        </a>
                    </li>
                    <li class="nk-menu-item">
                        <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/pembangunan">
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/gis/clear">
                                    <i class="fa fa-globe"></i>
                                    Peta
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/plan">
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/sms">
                                    <i class="fa fa-envelope-open-o"></i>
                                    SMS
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/sms/kontak">
                                    <i class="fa fa-id-card-o"></i>
                                    Daftar Kontak
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/sms/setting">
                                    <i class="fa fa-gear"></i>
                                    Pengaturan SMS
                                </a>
                            </li>
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/modul/clear">
                                    <i class="fa fa-tags"></i>
                                    Modul
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/setting">
                                    <i class="fa fa-codepen"></i>
                                    Aplikasi
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/man_user/clear">
                                    <i class="fa fa-users"></i>
                                    Pengguna
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/database">
                                    <i class="fa fa-database"></i>
                                    Database
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/setting/info_sistem">
                                    <i class="fa fa-server"></i>
                                    Info Sistem
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/setting/qrcode/clear">
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/web/clear">
                                    <i class="fa fa-file-movie-o"></i>
                                    Artikel
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/web_widget/clear">
                                    <i class="fa fa-windows"></i>
                                    Widget
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/menu/clear">
                                    <i class="fa fa-bars"></i>
                                    Menu
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/komentar/clear">
                                    <i class="fa fa-comments"></i>
                                    Komentar
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/gallery/clear">
                                    <i class="fa fa-image"></i>
                                    Galeri
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/sosmed">
                                    <i class="fa fa-facebook"></i>
                                    Media Sosial
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/web/slider">
                                    <i class="fa fa-film"></i>
                                    Slider
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/teks_berjalan">
                                    <i class="fa fa-ellipsis-h"></i>
                                    Teks Berjalan
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/pengunjung/clear">
                                    <i class="fa fa-bar-chart"></i>
                                    Pengunjung
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/setting/web">
                                    <i class="fa fa-gear"></i>
                                    Pengaturan
                                </a>
                            </li>
                    ...
                    <li class="nk-menu-item has-sub">
                        <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/">
                            <i class="fa fa-inbox"></i><span>Layanan Mandiri</span>
                            <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                        </a>
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/permohonan_surat_admin/clear">
                                    <i class="fa fa-files-o"></i>
                                    Permohonan Surat
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/mailbox/clear">
                                    <i class="fa fa-wechat"></i>
                                    Kotak Pesan
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/mandiri/clear">
                                    <i class="fa fa-500px"></i>
                                    Pendaftar Layanan Mandiri
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/anjungan">
                                    <i class="fa fa-desktop"></i>
                                    Anjungan
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a class="nk-menu-link" data-target="" href="https://demo.opensid.or.id/setting/mandiri">
                                    <i class="fa fa-gear"></i>
                                    Pengaturan
                                </a>
                            </li>
