"use strict";
!function(u, p) {
    u.Package.name = "DashLite",
    u.Package.version = "2.3";
    var c = p(window)
      , a = p("body")
      , l = p(document)
      , t = "nk-menu"
    ...
    u.CurrentLink = function() {
        ...
        p(".nk-menu-link, .menu-link, .nav-link").each(function() {
            ...
            p(".nk-menu-switch").parent().removeClass("active"),
            p("." + o).removeClass(s),
            e = t.closest("." + o).data("content"),
            t.closest("." + o).addClass(s),
            p("[data-target=" + e + "]").parent().addClass("active")) : t.closest("li").removeClass("active current-page").parents().closest("li:not(.current-page)").removeClass("active")
        })
    }
    ,
    ...
    u.Toast = function(t, e, n) {
        var a = ""
          , i = "info" === (e = e || "info") ? "ni ni-info-fill" : "success" === e ? "ni ni-check-circle-fill" : "error" === e ? "ni ni-cross-circle-fill" : "warning" === e ? "ni ni-alert-fill" : ""
          , o = {
        ...
        o.icon = "auto" === o.icon ? i : o.icon || "",
        o.ui = o.ui ? " " + o.ui : "",
        a = "" !== o.icon ? '<span class="toastr-icon"><em class="icon ' + o.icon + '"></em></span>' : "",
        "" !== (t = "" !== t ? a + '<div class="toastr-text">' + t + "</div>" : "") && (!0 === o.clear && toastr.clear(),
        a = {
            closeButton: !0,
            debug: !1,
            newestOnTop: !1,
    ...
    u.TGL.content = function(t, e) {
        ...
        l.on("mouseup", function(t) {
            ...
            e.is(t.target) || 0 !== e.has(t.target).length || o.is(t.target) || 0 !== o.has(t.target).length || n.is(t.target) || 0 !== n.has(t.target).length || a.is(t.target) || 0 !== a.has(t.target).length || i.is(t.target) || 0 !== i.has(t.target).length || (u.Toggle.removed(e.data("target"), r),
            s = !1))
        }),
        c.on("resize", function() {
            o.each(function() {
    ...
    u.TGL.expand = function(t, e) {
        ...
        p(n).on("click", function(t) {
            u.Toggle.trigger(p(this).data("target"), a),
            t.preventDefault()
        })
    }
    ,
    u.TGL.ddmenu = function(t, e) {
        var n = t || ".nk-menu-toggle"
          ...
          , a = e ? g(t, e) : t;
        p(n).on("click", function(t) {
            (u.Win.width < f.lg || p(this).parents().hasClass(d)) && u.Toggle.dropMenu(p(this), a),
            t.preventDefault()
        })
    }
    ,
    u.TGL.showmenu = function(t, e) {
        var n = p(t || ".nk-nav-toggle")
          ...
          , o = e ? g(t, e) : t;
        n.on("click", function(t) {
            u.Toggle.trigger(p(this).data("target"), o),
            t.preventDefault()
        }),
        l.on("mouseup", function(t) {
        ...
        c.on("resize", function() {
            (u.Win.width < f.xl || u.Win.width < i) && u.Toggle.removed(n.data("target"), o)
        })
    }
    ,
    u.menuSwitch = function() {
        var a = p(".nk-menu-switch")
          , i = p("." + o);
    ...
    u.DataTable = function(t, o) {
        p(t).exists() && p(t).each(function() {
            var t = p(this).data("auto-responsive")
              ...
              , i = e ? " with-export" : ""
              , e = '<"row justify-between g-2' + i + '"<"col-7 col-sm-4 text-left"f><"col-5 col-sm-8 text-right"<"datatable-filter"<"d-flex justify-content-end g-2"' + a + 'l>>>><"datatable-wrap my-3"t><"row align-items-center"<"col-7 col-sm-12 col-md-9"p><"col-5 col-sm-12 col-md-3 text-left text-md-right"i>>'
              , a = '<"row justify-between g-2' + i + '"<"col-7 col-sm-4 text-left"f><"col-5 col-sm-8 text-right"<"datatable-filter"<"d-flex justify-content-end g-2"' + a + 'l>>>><"my-3"t><"row align-items-center"<"col-7 col-sm-12 col-md-9"p><"col-5 col-sm-12 col-md-3 text-left text-md-right"i>>'
              , e = {
                responsive: !0,
                autoWidth: !1,
    ...
    u.BS.tabfix = function(t) {
        p(t || '[data-toggle="modal"]').on("click", function() {
            ...
            t && "#" !== t && n ? n.find('[href="' + t + '"]').tab("show") : n && (n = n.find(".nk-nav.nav-tabs"),
    ...
    u.Range.init = function() {
        u.Range(".form-control-slider"),
        u.Range(".form-range-slider")
    }
    ,
    ...
    u.BS.init = function() {
        ...
        u.BS.tooltip(".btn-tooltip", {
            placement: "top"
        }),
        u.BS.tooltip('[data-toggle="tooltip"]'),
        u.BS.tooltip(".tipinfo,.nk-menu-tooltip", {
            placement: "right"
        }),
