                    ...
                    <div class="nk-content-body">
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Patinent/ <strong class="text-primary small"><?= $row['nama']?></strong></h3>
                            </div>
                        </div>
                                ...
                                <div class="card-aside-wrap">
                                    <div class="card-content">
                                        <ul class="nav nav-tabs nav-tabs-mb-icon nav-tabs-card">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-toggle="tab" href="#tabItem1"><em class="icon ni ni-user-circle-fill"></em><span>Personal information</span></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#tabItem2"><em class="icon ni ni-property"></em><span>Diagnosis</span></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#tabItem3"><em class="icon ni ni-capsule-fill"></em><span>Prescription</span></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#tabItem4"><em class="icon ni ni-money"></em><span>Charges</span></a>
                                            </li>
                                            <li class="nav-item">
                                                    ...
                                                    <div class="nk-block">
                                                        <div class="profile-ud-list">
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider"><span class="profile-ud-label">Name</span><span class="profile-ud-value">Abu Bin Ishtiyak</span></div>
                                                            </div>
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider"><span class="profile-ud-label">Gender</span><span class="profile-ud-value">Male</span></div>
                                                            </div>
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider"><span class="profile-ud-label">Age</span><span class="profile-ud-value">41 years 0 months 3 days</span></div>
                                                            </div>
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider"><span class="profile-ud-label">Mobile</span><span class="profile-ud-value">+811 847-4958</span></div>
                                                            </div>
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider"><span class="profile-ud-label">Date of Birth</span><span class="profile-ud-value">10 Aug, 1980</span></div>
                                                            </div>
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider"><span class="profile-ud-label">Patient ID</span><span class="profile-ud-value">#P7085</span></div>
                                                            </div>
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider"><span class="profile-ud-label">Bed</span><span class="profile-ud-value">104 - VIP Ward - 1st Floor</span></div>
                                                            </div>
                                                            <div class="profile-ud-item">
                                                        ...
                                                        <div class="card">
                                                            <div class="nk-tb-list nk-tb-ulist is-compact">
                                                                ...
                                                                <div class="nk-tb-item">
                                                                    ...
                                                                    <div class="nk-tb-col tb-col-md"><span>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Modi ipsam molestiae aut.</span></div>
                                                                ...
                                                                <div class="nk-tb-item">
                                                                    <div class="nk-tb-col"><span>Blood Test</span></div>
                                                                    <div class="nk-tb-col tb-col-sm"><span>11 Feb 2020</span></div>
                                                                    <div class="nk-tb-col tb-col-md"><span>Dolor sit amet consectetur adipisicing elit. Modi ipsam molestiae aut.</span></div>
                                                                    <div class="nk-tb-col"><span class="tb-status text-warning">Pending</span></div>
                                                                    <div class="nk-tb-col nk-tb-col-tools">
                                                                        <ul class="nk-tb-actions gx-2">
                                                                            <li class="nk-tb-action-hidden">
                                                                                <a href="#" class="btn btn-sm btn-icon btn-trigger" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                ...
                                                                <div class="nk-tb-item">
                                                                    ...
                                                                    <div class="nk-tb-col tb-col-sm"><span>11 Feb 2020</span></div>
                                                                    <div class="nk-tb-col tb-col-md"><span>Tempore aut incidunt accusamus accusantium deleniti? Labore odio aperiam mollitia quaerat quos!</span></div>
                                                                    <div class="nk-tb-col"><span class="tb-status text-warning">Pending</span></div>
                                                                    <div class="nk-tb-col nk-tb-col-tools">
                                                                        <ul class="nk-tb-actions gx-2">
                                                                            <li class="nk-tb-action-hidden">
                                                                ...
                                                                <div class="nk-tb-item">
                                                                    <div class="nk-tb-col"><span>Vascular Sonography</span></div>
                                                                    <div class="nk-tb-col tb-col-sm"><span>10 Feb 2020</span></div>
                                                                    <div class="nk-tb-col tb-col-md"><span>Lquia soluta illo sed veniam repudiandae esse sequi qui impedit facilis laboriosam sapiente suscipit!</span></div>
                                                                    <div class="nk-tb-col"><span class="tb-status text-success">Done</span></div>
                                                                    <div class="nk-tb-col nk-tb-col-tools">
                                                                        <ul class="nk-tb-actions gx-2">
                                                                            <li class="nk-tb-action-hidden">
