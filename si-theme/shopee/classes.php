							...
							<div class="widget-body no-padding">
								...
								<form action="" method="post" id="contact-form" class="smart-form">
									...
									<fieldset>					
										...
										<section>
											<label class="label">Numeric Name</label>
											<label class="input"> 
								...
								<table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
							        ...
							        <tbody>
							        	<?php 
							        		...
							        		$q = mysqli_query($conn, "SELECT * FROM classes, schools, teachers WHERE classes.npsn=schools.npsn AND classes.classTeacher=teachers.idPtk");
							        		$no = 1;
