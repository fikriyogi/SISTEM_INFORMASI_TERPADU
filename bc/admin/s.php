...
<head>
    ...
    <link rel="stylesheet" href="/demo7/assets/css/dashlite.css?ver=2.9.0">
                    ...
                    <div class="nk-sidebar-profile nk-sidebar-profile-fixed dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-md ml-4">
                            ...
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    <li>
                                        <a href="/demo7/user-profile.html">
                                                ...
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col">
                                                        <div class="user-card">
                                                            ...
                                                            <div class="user-info">
                                                                        <span class="tb-lead">
                                                                            Abu Isthiyak <span class="dot dot-info d-md-none ml-1"></span>
                                                                        </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col">
                                                        <div class="user-card">
                                                            ...
                                                            <div class="user-info">
                                                                        <span class="tb-lead">
                                                                            Amelia Grant <span class="dot dot-gray d-md-none ml-1"></span>
                                                                        </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="nk-tb-col tb-col-md">
                                                        ...
                                                        <span data-toggle="tooltip" title="Visited at 11 Fab, 2021 01:02 PM" data-placement="top">
                                                                    <em class="icon ni ni-info"></em>
                                                                </span>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-xxl">
                                                ...
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col">
                                                        <div class="user-card">
                                                            ...
                                                            <div class="user-info">
                                                                        <span class="tb-lead">
                                                                            Kristen Hawkins <span class="dot dot-gray d-md-none ml-1"></span>
                                                                        </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="nk-tb-col tb-col-md">
                                                        <span class="tb-status text-grey">Visited</span>
                                                        <span data-toggle="tooltip" title="Visited at 11 Jun, 2021 01:02 PM" data-placement="top">
                                                                    <em class="icon ni ni-info"></em>
                                                                </span>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-xxl">
                                                ...
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col">
                                                        <div class="user-card">
                                                            ...
                                                            <div class="user-info">
                                                                        <span class="tb-lead">
                                                                            Tommy Vasquez <span class="dot dot-danger d-md-none ml-1"></span>
                                                                        </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="nk-tb-col tb-col-md">
                                                        ...
                                                        <span data-toggle="tooltip" title="Canceled at 11 Jul, 2021 04:05 PM" data-placement="top">
                                                                    <em class="icon ni ni-info"></em>
                                                                </span>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-xxl">
                                                ...
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col">
                                                        <div class="user-card">
                                                            ...
                                                            <div class="user-info">
                                                                        <span class="tb-lead">
                                                                            Alejandro Haynes <span class="dot dot-info d-md-none ml-1"></span>
                                                                        </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="nk-tb-col tb-col-md">
                                                        <span class="tb-status text-info">Waiting</span>
                                                        <span data-toggle="tooltip" title="Waiting at 10 May, 2021 04:05 PM" data-placement="top">
                                                                    <em class="icon ni ni-info"></em>
                                                                </span>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-xxl">
                                                ...
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col">
                                                        <div class="user-card">
                                                            ...
                                                            <div class="user-info">
                                                                        <span class="tb-lead">
                                                                            Brooke Harmon <span class="dot dot-gray d-md-none ml-1"></span>
                                                                        </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="nk-tb-col tb-col-md">
                                                        <span class="tb-status text-grey">Visited</span>
                                                        <span data-toggle="tooltip" title="Visited at 10 May, 2021 04:05 PM" data-placement="top">
                                                                    <em class="icon ni ni-info"></em>
                                                                </span>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-xxl">
                                                ...
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col">
                                                        <div class="user-card">
                                                            ...
                                                            <div class="user-info">
                                                                        <span class="tb-lead">
                                                                            Trevor Miller <span class="dot dot-gray d-md-none ml-1"></span>
                                                                        </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col">
                                                        <div class="user-card">
                                                            ...
                                                            <div class="user-info">
                                                                        <span class="tb-lead">
                                                                            Lonnie Ferguson <span class="dot dot-info d-md-none ml-1"></span>
                                                                        </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col">
                                                        <div class="user-card">
                                                            ...
                                                            <div class="user-info">
                                                                        <span class="tb-lead">
                                                                            Mack Kennedy <span class="dot dot-gray d-md-none ml-1"></span>
                                                                        </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="nk-tb-col tb-col-md">
                                                        <span class="tb-status text-grey">Visited</span>
                                                        <span data-toggle="tooltip" title="Visited at 10 Fab, 2021 04:05 PM" data-placement="top">
                                                                    <em class="icon ni ni-info"></em>
                                                                </span>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-xxl">
                                                ...
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col">
                                                        <div class="user-card">
                                                            ...
                                                            <div class="user-info">
                                                                        <span class="tb-lead">
                                                                            Inez Wilkerson <span class="dot dot-gray d-md-none ml-1"></span>
                                                                        </span>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <div class="row g-gs">
                        ...
                        <div class="col-12">
                            <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                <li>
                                    <button data-dismiss="modal" class="btn btn-primary">Add Appointment</button>
                                </li>
                                <li>
    ...
    <div class="nk-demo-list" data-simplebar>
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo1/index.html">
                <div class="nk-demo-image bg-blue">
                    <img class="bg-purple" src="https://dashlite.net/images/landing/layout-1d.jpg" srcset="https://dashlite.net/images/landing/layout-1d2x.jpg 2x" alt="Demo Layout 1">
                </div>
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo2/index.html">
                <div class="nk-demo-image bg-purple">
                    <img src="https://dashlite.net/images/landing/layout-2d.jpg" srcset="https://dashlite.net/images/landing/layout-2d2x.jpg 2x" alt="Demo Layout 2">
                </div>
                <span class="nk-demo-title">
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo3/index.html">
                <div class="nk-demo-image bg-success">
                    <img src="https://dashlite.net/images/landing/layout-3d.jpg" srcset="https://dashlite.net/images/landing/layout-3d2x.jpg 2x" alt="Demo Layout 3">
                </div>
                <span class="nk-demo-title">
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo4/index.html">
                <div class="nk-demo-image bg-indigo">
                    <img src="https://dashlite.net/images/landing/layout-4d.jpg" srcset="https://dashlite.net/images/landing/layout-4d2x.jpg 2x" alt="Demo Layout 4">
                </div>
                <span class="nk-demo-title">
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo5/index.html">
                <div class="nk-demo-image bg-orange">
                    <img src="https://dashlite.net/images/landing/layout-5d.jpg" srcset="https://dashlite.net/images/landing/layout-5d2x.jpg 2x" alt="Demo Layout 5">
                </div>
                <span class="nk-demo-title">
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo6/index.html">
                <div class="nk-demo-image bg-purple">
                    <img src="https://dashlite.net/images/landing/layout-6d.jpg" srcset="https://dashlite.net/images/landing/layout-6d2x.jpg 2x" alt="Demo Layout 6">
                </div>
                <span class="nk-demo-title">
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo7/index.html">
                <div class="nk-demo-image bg-teal">
                    <img src="https://dashlite.net/images/landing/layout-7d.jpg" srcset="https://dashlite.net/images/landing/layout-7d2x.jpg 2x" alt="Demo Layout 7">
                </div>
                <span class="nk-demo-title">
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo8/index.html">
                <div class="nk-demo-image bg-azure">
                    <img src="https://dashlite.net/images/landing/layout-8d.jpg" srcset="https://dashlite.net/images/landing/layout-8d2x.jpg 2x" alt="Demo Layout 8">
                </div>
                <span class="nk-demo-title">
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/landing/index.html">
                <div class="nk-demo-image bg-red">
                    <img src="https://dashlite.net/images/landing/main-landing.jpg" srcset="https://dashlite.net/images/landing/main-landing2x.jpg 2x" alt="Landing Page">
                </div>
                <span class="nk-demo-title">
...
<div class="nk-demo-panel nk-demo-panel-2x toggle-slide toggle-slide-right" data-content="demoUC" data-toggle-overlay="true" data-toggle-body="true" data-toggle-screen="any">
    <div class="nk-demo-head">
        ...
        <a class="nk-demo-close toggle btn btn-icon btn-trigger revarse mr-n2" data-target="demoUC" href="#">
            <em class="icon ni ni-cross"></em>
        </a>
    </div>
    <div class="nk-demo-list" data-simplebar>
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo2/ecommerce/index.html">
                <div class="nk-demo-image bg-dark">
                    <img src="https://dashlite.net/images/landing/demo-ecommerce.jpg" srcset="https://dashlite.net/images/landing/demo-ecommerce2x.jpg 2x" alt="Ecommerce">
                </div>
                <span class="nk-demo-title">
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo2/lms/index.html">
                <div class="nk-demo-image bg-danger">
                    <img src="https://dashlite.net/images/landing/demo-lms.jpg" srcset="https://dashlite.net/images/landing/demo-lms2x.jpg 2x" alt="LMS">
                </div>
                <span class="nk-demo-title">
                            <em class="text-primary">Demo2</em>
                            <br>
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo1/crm/index.html">
                <div class="nk-demo-image bg-info">
                    <img src="https://dashlite.net/images/landing/demo-crm.jpg" srcset="https://dashlite.net/images/landing/demo-crm2x.jpg 2x" alt="CRM / Customer Relationship">
                </div>
                <span class="nk-demo-title">
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo7/hospital/index.html">
                <div class="nk-demo-image bg-indigo">
                    <img src="https://dashlite.net/images/landing/demo-hospital.jpg" srcset="https://dashlite.net/images/landing/demo-hospital2x.jpg 2x" alt="Hospital Managemen">
                </div>
                <span class="nk-demo-title">
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo1/hotel/index.html">
                <div class="nk-demo-image bg-pink">
                    <img src="https://dashlite.net/images/landing/demo-hotel.jpg" srcset="https://dashlite.net/images/landing/demo-hotel2x.jpg 2x" alt="Hotel Managemen">
                </div>
                <span class="nk-demo-title">
                            <em class="text-primary">Demo1</em>
                            <br>
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo3/cms/index.html">
                <div class="nk-demo-image bg-dark">
                    <img src="https://dashlite.net/images/landing/demo-cms.jpg" srcset="https://dashlite.net/images/landing/demo-cms2x.jpg 2x" alt="cms">
                </div>
                <span class="nk-demo-title">
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo5/crypto/index.html">
                <div class="nk-demo-image bg-warning">
                    <img src="https://dashlite.net/images/landing/demo-buysell.jpg" srcset="https://dashlite.net/images/landing/demo-buysell2x.jpg 2x" alt="Crypto BuySell / Wallet">
                </div>
                <span class="nk-demo-title">
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo6/invest/index.html">
                <div class="nk-demo-image bg-indigo">
                    <img src="https://dashlite.net/images/landing/demo-invest.jpg" srcset="https://dashlite.net/images/landing/demo-invest2x.jpg 2x" alt="HYIP / Investment">
                </div>
                <span class="nk-demo-title">
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo3/apps/file-manager.html">
                <div class="nk-demo-image bg-purple">
                    <img src="https://dashlite.net/images/landing/demo-file-manager.jpg" srcset="https://dashlite.net/images/landing/demo-file-manager2x.jpg 2x" alt="File Manager">
                </div>
                <span class="nk-demo-title">
                            <em class="text-primary">Demo3</em>
                            <br>
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo4/subscription/index.html">
                <div class="nk-demo-image bg-primary">
                    <img src="https://dashlite.net/images/landing/demo-subscription.jpg" srcset="https://dashlite.net/images/landing/demo-subscription2x.jpg 2x" alt="SAAS / Subscription">
                </div>
                <span class="nk-demo-title">
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/covid/index.html">
                <div class="nk-demo-image bg-danger">
                    <img src="https://dashlite.net/images/landing/demo-covid19.jpg" srcset="https://dashlite.net/images/landing/demo-covid192x.jpg 2x" alt="Covid Situation">
                </div>
                <span class="nk-demo-title">
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo3/apps/messages.html">
                <div class="nk-demo-image bg-success">
                    <img src="https://dashlite.net/images/landing/demo-messages.jpg" srcset="https://dashlite.net/images/landing/demo-messages2x.jpg 2x" alt="Messages">
                </div>
                <span class="nk-demo-title">
                            <em class="text-primary">Demo3</em>
                            <br>
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo3/apps/mailbox.html">
                <div class="nk-demo-image bg-purple">
                    <img src="https://dashlite.net/images/landing/demo-inbox.jpg" srcset="https://dashlite.net/images/landing/demo-inbox2x.jpg 2x" alt="Inbox">
                </div>
                <span class="nk-demo-title">
                            <em class="text-primary">Demo3</em>
                            <br>
        ...
        <div class="nk-demo-item">
            <a href="https://dashlite.net/demo3/apps/chats.html">
                <div class="nk-demo-image bg-purple">
                    <img src="https://dashlite.net/images/landing/demo-chats.jpg" srcset="https://dashlite.net/images/landing/demo-chats2x.jpg 2x" alt="Chats / Messenger">
                </div>
                <span class="nk-demo-title">
                            <em class="text-primary">Demo3</em>
                            <br>
    ...
    <div class="nk-opt-panel" data-simplebar>
        ...
        <div class="nk-opt-set">
            ...
            <div class="nk-opt-list col-2x">
                ...
                <div class="nk-opt-item only-text" data-key="style" data-update="ui-softy">
                            <span class="nk-opt-item-bg">
                                <span class="nk-opt-item-name">Softy</span>
                            </span>
                </div>
            </div>
        </div>
        <div class="nk-opt-set nk-opt-set-aside">
            ...
            <div class="nk-opt-list col-4x">
                ...
                <div class="nk-opt-item active" data-key="aside" data-update="is-dark">
                            <span class="nk-opt-item-bg">
        ...
        <div class="nk-opt-set nk-opt-set-aside-nav">
            ...
            <div class="nk-opt-list col-4x">
                <div class="nk-opt-item" data-key="navside" data-update="is-light">
                            <span class="nk-opt-item-bg is-light">
                                <span class="bg-lighter"></span>
                            </span>
                    <span class="nk-opt-item-name">White</span>
                </div>
                <div class="nk-opt-item" data-key="navside" data-update="is-default">
                            <span class="nk-opt-item-bg is-light">
                                <span class="bg-light"></span>
                            </span>
                    <span class="nk-opt-item-name">Light</span>
                </div>
                <div class="nk-opt-item active" data-key="navside" data-update="is-dark">
                            <span class="nk-opt-item-bg">
                                <span class="bg-dark"></span>
                            </span>
                    <span class="nk-opt-item-name">Dark</span>
                </div>
                <div class="nk-opt-item" data-key="navside" data-update="is-theme">
                            <span class="nk-opt-item-bg">
                                <span class="bg-theme"></span>
                            </span>
                    <span class="nk-opt-item-name">Theme</span>
...
<div class="pmo-lv pmo-dark">
    ...
    <a class="pmo-wrap" target="_blank" href="https://softnio.com/get-early-access/">
        <div class="pmo-text text-white">
            Looking for functional script for HYIP Investment Platform? Check out <em class="ni ni-arrow-long-right"></em>
        </div>
    </a>
</div>
<a class="pmo-st pmo-dark" target="_blank" href="https://softnio.com/get-early-access/">
    <div class="pmo-st-img">
        <img src="https://dashlite.net/images/landing/promo-investorm.png" alt="Investorm">
    </div>
    <div class="pmo-st-text">
        Looking for Advanced <br>HYIP Investment Platform?
    </div>
</a>
<script src="/demo7/assets/js/bundle.js?ver=2.9.0"></script>
<script src="/demo7/assets/js/scripts.js?ver=2.9.0"></script>
<script src="/demo7/assets/js/demo-settings.js?ver=2.9.0"></script>
</body>
</html>
