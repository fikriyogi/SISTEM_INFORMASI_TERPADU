...
!function(u, p) {
    ...
    u.TGL.ddmenu = function(t, e) {
        var n = t || ".nk-menu-toggle"
          ...
          , a = e ? f(t, e) : t;
        p(n).on("click", function(t) {
            (u.Win.width < d.lg || p(this).parents().hasClass(i)) && u.Toggle.dropMenu(p(this), a),
            t.preventDefault()
        })
    }
    ,
    u.TGL.showmenu = function(t, e) {
        ...
        c.on("resize", function() {
            (u.Win.width < d.xl || u.Win.width < i) && u.Toggle.removed(n.data("target"), o)
        })
    }
    ,
