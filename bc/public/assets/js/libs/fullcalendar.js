var FullCalendar = function(e) {
    ...
    function E(e, t) {
        if (null == t)
            return e.__ ? E(e.__, e.__.__k.indexOf(e) + 1) : null;
    ...
    function C(e, t, n, r, o, i, a, s, l, u) {
        ...
        for (n.__e = S,
        p = C; p--; )
            null != D[p] && ("function" == typeof n.type && null != D[p].__e && D[p].__e == n.__d && (n.__d = E(r, p + 1)),
            O(D[p], D[p]));
        if (b)
    ...
    function w(e, t, n) {
        ...
        for (r = 0; r < e.__k.length; r++)
            (o = e.__k[r]) && (o.__ = e,
            t = "function" == typeof o.type ? w(o, t, n) : _(n, o, o, e.__k, o.__e, t));
        return t
    }
    function R(e, t) {
        return t = t || [],
    ...
    function N(e, t, n, r, o, i, a, s) {
        ...
        if (null === m)
            ...
            if (i = i && d.slice.call(e.childNodes),
            ...
            C(e, Array.isArray(y) ? y : [y], t, n, r, o && "foreignObject" !== m, i, a, e.firstChild, s),
            null != i)
                for (y = i.length; y--; )
                    null != i[y] && h(i[y]);
    ...
    ee.prototype.render = function(e, t) {
        ...
        return o && (o.__h = null),
        [v(m, null, t.__e ? null : e.children), o]
    }
    ;
    ...
    i.vnode = function(e) {
        ...
        t && n.class != n.className && (fe.enumerable = "className"in n,
    ...
    ge.FullCalendarVDom ? console.warn("FullCalendar VDOM already loaded") : ge.FullCalendarVDom = {
        ...
        flushToDom: function() {
            var e = i.debounceRendering
              , t = [];
            for (i.debounceRendering = function(e) {
                t.push(e)
            }
            ,
            L(v(me, {}), document.createElement("div")); t.length; )
                t.shift()();
    ...
    function Ve(e) {
        ...
        e.addEventListener("selectstart", Me)
    }
    function Fe(e) {
    ...
    function wt(e, t) {
        if (e === t)
            return !0;
        for (var n in e)
            if (yt.call(e, n) && !(n in t))
                return !1;
        for (var n in t)
            if (yt.call(t, n) && e[n] !== t[n])
                return !1;
        return !0
    }
    function Rt(e, t) {
      ...
      , tn = function() {
        ...
        e.prototype.formatRange = function(e, t, n, r) {
            var o = this.standardDateProps
              ...
              , a = function(e, t, n) {
                return n.getMarkerYear(e) !== n.getMarkerYear(t) ? 5 : n.getMarkerMonth(e) !== n.getMarkerMonth(t) ? 4 : n.getMarkerDay(e) !== n.getMarkerDay(t) ? 2 : gt(e) !== gt(t) ? 1 : 0
    ...
    function nn(e, t, n) {
        ...
        : 0 === o && t.week ? function(e) {
            return function(e, t, n, r, o) {
                var i = [];
                return "long" === o ? i.push(n) : "short" !== o && "narrow" !== o || i.push(t),
            ...
            return function(r) {
                ...
                return function(e, t, n, r, o) {
                    ...
                    "short" === n.timeZoneName && (e = function(e, t) {
                        var n = !1;
                        return e = e.replace(en, (function() {
                            return n = !0,
                            t
                        }
                        )),
    ...
    function En(e, t, n, r) {
        for (var o = {
            defs: {},
            instances: {}
        }, i = On(n), a = 0, s = e; a < s.length; a++) {
            var l = Nn(s[a], t, n, r, i);
            l && Sn(l, o)
        }
        return o
    }
    ...
    function Nn(e, t, n, r, o) {
        ...
        if (u)
            return (c = An(a, s, t ? t.sourceId : "", u.allDay, Boolean(u.duration), n)).recurringDef = {
                typeId: u.typeId,
                typeData: u.typeData,
                duration: u.duration
            },
        ...
        return d ? {
            def: c = An(a, s, t ? t.sourceId : "", d.allDay, d.hasEnd, n),
            instance: mt(c.defId, d.range, d.forcedStartTzo, d.forcedEndTzo)
        } : null
    }
    function Hn(e, t, n) {
        return void 0 === n && (n = On(t)),
        mn(e, n)
    }
    function On(e) {
        return r(r(r({}, Rn), Pn), e.pluginHooks.eventRefiners)
    }
    ...
    function Zn(e, t, n, r) {
        ...
        for (var m in o)
            for (var y = 0, E = Fn(o[m], n); y < E.length; y++) {
                var S, b = E[y];
                f = u[(S = a[m]).defId],
                s.push({
                    def: S,
        ...
        for (var c in i)
            for (var D = 0, C = Fn(i[c], n); D < C.length; D++)
                b = C[D],
                s.push({
                    def: e.defs[c],
                    ui: u[c],
    ...
    function dr(e, t, n) {
        var o = function(e, t) {
            var n = mn(e, cr)
              ...
              , l = o.allDay;
            return null == l && (l = a && a.isTimeUnspecified && (!s || s.isTimeUnspecified)),
            r({
                range: {
    ...
    function vr(e, t, n) {
        var r = Hn({
          ...
          , o = An(r.refined, r.extra, "", e.allDay, !0, n);
        return {
            def: o,
            ui: Qn(o, t),
    ...
    function gr(e, t, n) {
        n.emitter.trigger("select", r(r({}, mr(e, n)), {
    ...
    function Er(e, t, n, r) {
        ...
        for (var l in e.instances) {
            var u = e.instances[l];
            s = i.defs[u.defId],
            i.instances[l] = br(u, s, o[u.defId], n, r)
        }
        return i
    }
    function Sr(e, t, n, o) {
    ...
    function br(e, t, n, o, i) {
        ...
        l && (u.range = {
            start: u.range.start,
            end: yr(t.allDay, u.range.start, i)
        }),
        t.allDay && (u.range = {
            start: lt(u.range.start),
            end: lt(u.range.end)
        }),
        u.range.end < u.range.start && (u.range.end = yr(t.allDay, u.range.start, i)),
        u
    }
    var Dr = function() {
        function e(e, t, n) {
    ...
    function Rr(e) {
        return r(r(r({}, Rn), Cr), e.pluginHooks.eventSourceRefiners)
    }
    function _r(e, t) {
    ...
    var Tr = function() {
        ...
        e.prototype.today = function() {
            ...
            this.dispatch({
                type: "CHANGE_DATE",
                dateMarker: _r(e.calendarOptions.now, e.dateEnv)
            })
        }
        ,
        ...
        e.prototype.addEvent = function(e, t) {
            ...
            var s = Nn(e, o, i, !1);
            if (s) {
                var l = new kr(i,s.def,s.def.recurringDef ? null : s.instance);
      ...
      , kr = function() {
        ...
        e.prototype.setStart = function(e, t) {
            ...
            var n = this._context.dateEnv
              , r = n.createMarker(e);
            if (r && this._instance) {
                var o = Vn(this._instance.range.start, r, n, t.granularity);
        ...
        e.prototype.setEnd = function(e, t) {
            ...
            if ((null == e || (n = r.createMarker(e))) && this._instance)
                if (n) {
                    var o = Vn(this._instance.range.end, n, r, t.granularity);
                    this.mutate({
                        endDelta: o
                    })
                } else
        ...
        e.prototype.setDates = function(e, t, n) {
            ...
            if (l && (null == t || (r = a.createMarker(t))) && this._instance) {
                ...
                !0 === n.allDay && (u = Ln(u));
                var c = Vn(u.start, l, a, n.granularity);
                if (r) {
                    var d = Vn(u.end, r, a, n.granularity);
                    i = d,
    ...
    function Mr(e, t, n) {
        ...
        for (var s in o) {
            var l = o[s]
              , u = r[l.defId];
            l.instanceId !== a && i.push(new kr(t,u,l))
        }
        return i
    }
    var Ir, Pr = {};
    ...
    function Wr(e) {
        for (var t = e.length > 0 ? e[0].code : "en", n = Ar.concat(e), r = {
            en: Ur
    ...
    function Gr(e, t) {
        return En(function(e) {
            return (!0 === e ? [{}] : Array.isArray(e) ? e.filter((function(e) {
                return e.daysOfWeek
            }
            )) : "object" == typeof e && e ? [e] : []).map((function(e) {
                return r(r({}, jr), e)
            }
            ))
        }(e), null, t)
      ...
      , Qr = function() {
        ...
        return e.prototype.splitProps = function(e) {
            ...
            for (var c in this.eventUiBuilders = bt(n, (function(e, n) {
                return t.eventUiBuilders[n] || qt(eo)
            }
            )),
            n) {
                var d = n[c]
        ...
        e.prototype._splitInteraction = function(e) {
            ...
            if (e) {
                var n = this._splitEventStore(e.affectedEvents, this._getKeysForEventDefs(e.affectedEvents))
                  ...
                  , i = function(r) {
                    t[r] || (t[r] = {
                        affectedEvents: n[r] || Jr,
                        mutatedEvents: o[r] || Jr,
                        isEvent: e.isEvent
                    })
                };
                for (var a in n)
    ...
    function po(e, t) {
        ...
        return lo() && "rtl" === n.direction ? u.scrollbarLeft = l : u.scrollbarRight = l,
    ...
    function fo(e, t, n) {
        void 0 === t && (t = !1);
        var r = n ? e.getBoundingClientRect() : ho(e)
          , o = po(e, t)
          , i = {
    ...
    if (Do.prototype.classes = {},
    Do.prototype.iconClasses = {},
    Do.prototype.baseIconClass = "",
    Do.prototype.iconOverridePrefix = "",
    "undefined" == typeof FullCalendarVDom)
        throw new Error("Please import the top-level fullcalendar lib before attempting to import a plugin.");
    var Co = FullCalendarVDom.Component
      , wo = FullCalendarVDom.createElement
      , Ro = FullCalendarVDom.render
      , _o = FullCalendarVDom.createRef
      , To = FullCalendarVDom.Fragment
      , ko = FullCalendarVDom.createContext
      , xo = FullCalendarVDom.createPortal
      , Mo = FullCalendarVDom.flushToDom
      , Io = FullCalendarVDom.unmountComponentAtNode
      , Po = function() {
        function e(e, t, n, o) {
            var i = this;
            this.execFunc = e,
      ...
      , No = ko({});
    function Ho(e, t, n, r, o, i, a, s, l, u, c, d, p) {
        return {
            dateEnv: o,
            options: n,
            pluginHooks: a,
            ...
            createScrollResponder: function(e) {
                return new Po(e,u,Nt(n.scrollTime),n.scrollTimeReset)
            },
    ...
    var Oo = function(e) {
        ...
        t.prototype.shouldComponentUpdate = function(e, t) {
            return this.debug && console.log(Rt(e, this.props), Rt(t, this.state)),
            !_t(this.props, e, this.propEquality) || !_t(this.state, t, this.stateEquality)
        }
        ,
        t.addPropsEquality = Lo,
        t.addStateEquality = Uo,
        t.contextType = No,
        t
    }(Co);
    Oo.prototype.propEquality = {},
    Oo.prototype.stateEquality = {};
    var Ao = function(e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        }
    ...
    var jo = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.rootElRef = _o(),
            t.handleRootEl = function(e) {
                Wo(t.rootElRef, e),
                t.props.elRef && Wo(t.props.elRef, e)
            }
            ,
            t
        }
        ...
        t.prototype.render = function() {
            ...
            return wo(Zo, {
                ...
                return wo(qo, {
                    ...
                    return t.children(r, Ko(t.classNames, n), e, o)
                }
                ))
            }
            ))
      ...
      , Go = ko(0);
    function qo(e) {
        return wo(Go.Consumer, null, (function(t) {
            return wo(Yo, r({
                renderId: t
            }, e))
        }
    ...
    var Yo = function(e) {
        ...
        t.prototype.getInnerContent = function() {
            var e = this.props
              , t = $o(e.content, e.hookProps);
            return void 0 === t && (t = $o(e.defaultContent, e.hookProps)),
            null == t ? null : t
        }
        ,
    ...
    function $o(e, t) {
        return "function" == typeof e ? e(t, wo) : e
    }
    var Jo = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.normalizeClassNames = Xo(),
            t
        }
        return n(t, e),
        t.prototype.render = function() {
    ...
    function ei(e) {
        ...
        o = function(e) {
            return wo(No.Consumer, null, (function(n) {
                return wo(Jo, {
                    viewSpec: n.viewSpec
                }, (function(o, i) {
                    var a = r(r({}, e), {
    ...
    var ni = {}
      , ri = function() {
        function e(e) {
            this.props = e,
            this.nowDate = _r(e.nowInput, e.dateEnv),
            this.initHiddenDays()
        }
        ...
        e.prototype.build = function(e, t, n) {
            ...
            d.showNonCurrentDates || (s = zn(s, o.range)),
            s = zn(s = this.adjustActiveRange(s), r),
            l = Gn(o.range, r),
            {
                validRange: r,
        ...
        e.prototype.adjustActiveRange = function(e) {
            var t = this.props
              ...
              , a = e.start
              , s = e.end;
            return r && (Lt(o) < 0 && (a = lt(a),
            a = n.add(a, o)),
            Lt(i) > 1 && (s = tt(s = lt(s), -1),
            s = n.add(s, i))),
            {
                start: a,
                end: s
        ...
        e.prototype.buildDateIncrement = function(e) {
            var t;
            return this.props.dateIncrement || ((t = this.props.dateAlignment) ? Nt(1, t) : e || Nt({
                days: 1
            }))
        }
        ,
    ...
    function ai(e, t, n) {
        return si(e, St(e, (function(e) {
            return function(e, t, n) {
                return ci(e, n) ? !n.options.lazyFetching || !e.fetchRange || e.isFetching || t.start < e.fetchRange.start || t.end > e.fetchRange.end : !e.latestFetchId
            }(e, t, n)
        }
        )), t, !1, n)
    }
    ...
    function mi(e, t, n, r, o) {
        return {
            header: e.headerToolbar ? yi(e.headerToolbar, e, t, n, r, o) : null,
            footer: e.footerToolbar ? yi(e.footerToolbar, e, t, n, r, o) : null
        }
    }
    ...
    var Ci = [Fo({
        ...
        eventSourceDefs: [{
            ...
            fetch: function(e, t, n) {
                ...
                go(e.eventSource.meta.bind(null, fr(e.range, r)), (function(e) {
                    t({
                        rawEvents: e
                    })
                }
            ...
            fetch: function(e, t, n) {
                var o = e.eventSource.meta
                  , i = function(e, t, n) {
                    ...
                    return null == (o = e.startParam) && (o = u.startParam),
                ...
                Si(o.method, o.url, i, (function(e, n) {
                    t({
                        rawEvents: e,
                        xhr: n
                    })
        ...
        recurringTypes: [{
            ...
            expand: function(e, t, n) {
                ...
                return r ? function(e, t, n, r) {
                    for (var o = e ? Dt(e) : null, i = lt(n.start), a = n.end, s = []; i < a; ) {
                        var l = void 0;
        ...
        propSetHandlers: {
            dateProfile: function(e, t) {
                t.emitter.trigger("datesSet", r(r({}, fr(e.activeRange, t.dateEnv)), {
                    view: t.viewApi
                }))
            },
            eventStore: function(e, t) {
                var n = t.emitter;
                n.hasHandlers("eventsSet") && n.trigger("eventsSet", Mr(e, t))
            }
        }
    })]
      , wi = function() {
    ...
    var Ti = function() {
        function e(e) {
            ...
            this.organizeRawLocales = qt(Wr),
            this.buildLocale = qt(Vr),
            ...
            this.buildDateEnv = qt(ki),
            this.buildTheme = qt(xi),
            this.parseToolbars = qt(mi),
            this.buildViewSpecs = qt(ti),
            this.buildDateProfileGenerator = Yt(Mi),
            this.buildViewApi = qt(Ii),
            this.buildViewUiProps = Yt(Hi),
            this.buildEventUiBySource = qt(Pi, wt),
            this.buildEventUiBases = qt(Ni),
            this.parseContextBusinessHours = Yt(Ai),
            this.buildTitle = qt(_i),
            this.emitter = new mo,
            this.actionRunner = new Ri(this._handleAction.bind(this),this.updateData.bind(this)),
            ...
            l = o.dateEnv,
            null != (u = s.initialDate) ? l.createMarker(u) : _r(s.now, l)), d = a.dateProfileGenerator.build(c);
            Yn(d.activeRange, c) || (c = d.currentRange.start);
            for (var p = {
                dateEnv: o.dateEnv,
            ...
            Oi(g, p) && this.emitter.trigger("loading", !0),
            this.state = g,
            this.updateData(),
        ...
        e.prototype._handleAction = function(e) {
            ...
            "PREV" !== e.type && "NEXT" !== e.type && Yn(p.currentRange, d) || (d = p.currentRange.start);
            for (var f = function(e, t, n, o) {
                ...
                case "FETCH_EVENT_SOURCES":
                    return si(e, t.sourceIds ? Dt(t.sourceIds) : ui(e, o), s, t.isRefetch || !1, o);
                case "RECEIVE_EVENTS":
                case "RECEIVE_EVENT_ERROR":
                    return function(e, t, n, o) {
                        var i, a = e[t];
                        return a && n === a.latestFetchId ? r(r({}, e), ((i = {})[t] = r(r({}, a), {
                            isFetching: !1,
                            fetchRange: o
                        }),
                        i)) : e
            ...
            }(o.eventSources, e, p, c), h = function(e, t, n, r, o) {
                switch (t.type) {
                case "RECEIVE_EVENTS":
            ...
            }(o.eventStore, e, f, p, c), v = oi(f) && !u.options.progressiveEventRendering && o.renderableEventStore || h, g = this.buildViewUiProps(c), m = g.eventUiSingleBase, y = g.selectionConfig, E = this.buildEventUiBySource(f), S = {
                ...
                dateSelection: fi(o.dateSelection, e),
                eventSelection: hi(o.eventSelection, e),
                eventDrag: vi(o.eventDrag, e),
                eventResize: gi(o.eventResize, e)
            ...
            var R = Oi(o, c)
              , _ = Oi(S, c);
            !R && _ ? i.trigger("loading", !0) : R && !_ && i.trigger("loading", !1),
            this.state = S,
        ...
        e.prototype.processRawCalendarOptions = function(e, t) {
            var n = gn([cn, e, t])
              ...
              , u = this.buildPluginHooks(e.plugins || [], Ci)
              ...
              , g = !1;
            for (var m in p)
                "plugins" !== m && (p[m] === h[m] || fn[m] && m in h && fn[m](h[m], p[m]) ? f[m] = v[m] : c[m] ? (f[m] = c[m](p[m]),
                g = !0) : d[m] = h[m]);
      ...
      , Wi = function() {
        ...
        e.prototype.insertEntryAt = function(e, t) {
            var n = this.entriesByLevel
              , r = this.levelCoords;
            -1 === t.lateral ? (Gi(r, t.level, t.levelCoord),
            Gi(n, t.level, [e])) : Gi(n[t.level], t.lateral, e),
            this.stackCnts[Fi(e)] = t.stackCnt
        }
        ,
    ...
    var ta = function(e) {
            ...
            return n.handleSegClick = function(e, t) {
                ...
                if (i && r.isValidSegDownEl(e.target)) {
                    ...
                    o.emitter.trigger("eventClick", {
                        el: t,
                        event: new kr(r.context,i.eventRange.def,i.eventRange.instance),
                        jsEvent: e,
                        view: o.viewApi
                    }),
      ...
      , ia = function(e) {
        function t(t) {
            var n, r, o, i, a = e.call(this, t) || this;
            return a.handleEventElRemove = function(e) {
                e === a.currentSegEl && a.handleSegLeave(null, a.currentSegEl)
            }
            ,
            a.handleSegEnter = function(e, t) {
                $n(t) && (a.currentSegEl = t,
                a.triggerEvent("eventMouseEnter", e, t))
            }
            ,
            a.handleSegLeave = function(e, t) {
                a.currentSegEl && (a.currentSegEl = null,
                a.triggerEvent("eventMouseLeave", e, t))
            }
            ,
            a.removeHoverListeners = (n = t.el,
            ".fc-event",
            r = a.handleSegEnter,
            o = a.handleSegLeave,
            Ie(n, "mouseover", ".fc-event", (function(e, t) {
                if (t !== i) {
                    i = t,
                    r(e, t);
                    var n = function(e) {
      ...
      , aa = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.buildViewContext = qt(Ho),
            t.buildViewPropTransformers = qt(la),
            t.buildToolbarProps = qt(sa),
            t.headerRef = _o(),
            t.footerRef = _o(),
            t.interactionsStore = {},
            t.state = {
        ...
        return n(t, e),
        t.prototype.render = function() {
            var e, t = this.props, n = t.toolbarConfig, o = t.options, i = this.buildToolbarProps(t.viewSpec, t.dateProfile, t.dateProfileGenerator, t.currentDate, _r(t.options.now, t.dateEnv), t.viewTitle), a = !1, s = "";
            ...
            return wo(No.Provider, {
                ...
                aspectRatio: e,
                labeledById: u
            }, this.renderView(t), this.buildAppendContent()), n.footer && wo(na, r({
                ref: this.footerRef,
    ...
    function sa(e, t, n, r, o, i) {
        ...
        return {
            ...
            isTodayEnabled: a.isValid && !Yn(t.currentRange, o),
    ...
    var ua = function(e) {
        ...
        t.prototype.render = function() {
            ...
            return $r() || i.push("fc-liquid-hack"),
            e.children(i, o, r, n)
        }
        ,
        t.prototype.componentDidMount = function() {
    ...
    var fa = function(e) {
        ...
        t.prototype.render = function() {
            var e = this.context
              ...
              , s = a.date
              , l = a.dateProfile
              , u = to(s, a.todayRange, null, l)
              , c = [da].concat(no(u, o))
              , d = t.format(s, a.dayHeaderFormat)
              , p = !u.isDisabled && a.colCnt > 1 ? io(this.context, s) : {}
              , f = r(r(r({
                date: t.toDate(s),
                view: i
            }, a.extraHookProps), {
      ...
      , va = function(e) {
        ...
        t.prototype.render = function() {
            var e = this.props
              ...
              , u = [da].concat(no(l, o), e.extraClassNames || [])
            ...
            return wo(jo, {
                ...
                return wo("th", r({
                    ...
                    colSpan: e.colSpan
                }, e.extraDataAttrs), wo("div", {
                    className: "fc-scrollgrid-sync-inner"
                }, wo("a", {
                    "aria-label": n.format(s, ha),
      ...
      , ga = function(e) {
        function t(t, n) {
            ...
            return r.initialNowDate = _r(n.options.now, n.dateEnv),
    ...
    var ya = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.createDayHeaderFormatter = qt(Ea),
            t
        }
        return n(t, e),
        t.prototype.render = function() {
    ...
    var Sa = function() {
      ...
      , Da = function() {
        ...
        e.prototype._sliceBusinessHours = function(e, t, n, r) {
            for (var i = [], a = 4; a < arguments.length; a++)
                i[a - 4] = arguments[a];
            return e ? this._sliceEventStore.apply(this, o([xt(e, Ca(t, Boolean(n)), r), {}, t, n], i)).bg : []
        }
        ,
        ...
        e.prototype._sliceInteraction = function(e, t, n, r) {
            ...
            if (!e)
                return null;
            var a = Zn(e.mutatedEvents, t, Ca(n, Boolean(r)), r);
            return {
        ...
        e.prototype._sliceDateSpan = function(e, t, n) {
            ...
            if (!e)
                return [];
            for (var a = vr(e, t, n), s = this.sliceRange.apply(this, o([e.range], r)), l = 0, u = s; l < u.length; l++) {
                var c = u[l];
                c.eventRange = a
            }
            return s
    ...
    function Ra(e, t, n) {
        return !!qn(t.validRange, e.range) && _a({
            dateSelection: e
        }, n)
    }
    function _a(e, t) {
        ...
        return (t.pluginHooks.isPropsValid || Ta)(o, t)
    }
    function Ta(e, t, n, o) {
        return void 0 === n && (n = {}),
        !(e.eventDrag && !function(e, t, n, o) {
            var i = t.getCurrentData()
              ...
              , l = s.defs
              , u = s.instances
              , c = Jn(l, a.isEvent ? e.eventUiBases : {
                "": i.selectionConfig
            });
            o && (c = bt(c, o));
            var d, p, f = (d = e.eventStore,
            p = a.affectedEvents.instances,
            {
                defs: d.defs,
                instances: St(d.instances, (function(e) {
                    return !p[e.instanceId]
                }
                ))
            }), h = f.defs, v = f.instances, g = Jn(h, e.eventUiBases);
            for (var m in u) {
                var y = u[m]
                  , E = y.range
                  , S = c[y.defId]
                  , b = l[y.defId];
                if (!ka(S.constraints, E, f, e.businessHours, t))
                    return !1;
                ...
                for (var w in v) {
                    var R = v[w];
                    if (Gn(E, R.range)) {
                        if (!1 === g[R.defId].overlap && a.isEvent)
                            return !1;
                        if (!1 === S.overlap)
                            return !1;
                        if (C && !C(new kr(t,h[R.defId],R), new kr(t,b,y)))
                            return !1
                    }
                }
                for (var _ = i.eventStore, T = 0, k = S.allows; T < k.length; T++) {
                    var x, M = k[T], I = r(r({}, n), {
                        range: y.range,
                        allDay: b.allDay
                    }), P = _.defs[b.defId], N = _.instances[m];
                    if (x = P ? new kr(t,P,N) : new kr(t,b),
                    !M(mr(I, t), x))
                        return !1
                }
            }
            ...
            if (o && (c = o(c)),
            !ka(c.constraints, u, i, e.businessHours, t))
                return !1;
            ...
            for (var f in s) {
                ...
                if (Gn(u, h.range)) {
                    if (!1 === c.overlap)
                        return !1;
                    if (p && !p(new kr(t,a[h.defId],h), null))
                        return !1
                }
            }
            for (var v = 0, g = c.allows; v < g.length; v++)
                if (!(0,
                g[v])(mr(r(r({}, n), l), t), null))
                    return !1;
            return !0
        }(e, t, n, o))
    }
    function ka(e, t, n, r, o) {
        for (var i = 0, a = e; i < a.length; i++)
            if (!Ia(xa(a[i], t, n, r, o), t))
                return !1;
        return !0
    }
    function xa(e, t, n, r, o) {
        return "businessHours" === e ? Ma(xt(r, t, o)) : "string" == typeof e ? Ma(Cn(n, (function(t) {
            return t.groupId === e
        }
        ))) : "object" == typeof e && e ? Ma(xt(e, t, o)) : []
    }
    function Ma(e) {
        var t = e.instances
          , n = [];
    ...
    var Pa = /^(visible|hidden)$/
      , Na = function(e) {
        ...
        t.prototype.needsXScrolling = function() {
            if (Pa.test(this.props.overflowX))
                return !1;
        ...
        t.prototype.needsYScrolling = function() {
            if (Pa.test(this.props.overflowY))
                return !1;
    ...
    function La(e, t) {
        return null != t.maxHeight || Aa(e, t)
    }
    function Ua(e, t, n, r) {
        var o = n.expandRows;
        return "function" == typeof t.content ? t.content(n) : wo("table", {
            role: "presentation",
        ...
        }, n.tableColGroupNode, wo(r ? "thead" : "tbody", {
            role: "presentation"
    ...
    function Va(e, t) {
        for (var n = [], r = 0, i = e; r < i.length; r++)
            for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1)
                n.push(wo("col", {
                    style: {
                        width: "shrink" === a.width ? Fa(t) : a.width || "",
                        minWidth: a.minWidth || ""
                    }
                }));
        return wo.apply(void 0, o(["colgroup", {}], n))
    }
    function Fa(e) {
        return null == e ? 4 : e
    }
    ...
    var Za = function(e) {
        function t() {
            ...
            t.renderMicroColGroup = qt(Va),
            t.scrollerRefs = new Ha,
            t.scrollerElRefs = new Ha(t._handleScrollerEl.bind(t)),
            t.state = {
                shrinkWidth: null,
                forceYScrollbars: !1,
        ...
        t.prototype.render = function() {
            ...
            }, Boolean(!v && p.length) && wo.apply(void 0, o(["thead", g], p)), Boolean(!v && f.length) && wo.apply(void 0, o(["tbody", g], f)), Boolean(!v && h.length) && wo.apply(void 0, o(["tfoot", g], h)), v && wo.apply(void 0, o(o(o(["tbody", g], p), f), h)))
        }
        ,
        t.prototype.renderSection = function(e, t, n) {
            return "outerContent"in e ? wo(To, {
                key: e.key
            }, e.outerContent) : wo("tr", {
                key: e.key,
                role: "presentation",
                className: ja(e, this.props.liquid).join(" ")
        ...
        t.prototype.computeShrinkWidth = function() {
            return Ba(this.props.cols) ? Oa(this.scrollerElRefs.getAll()) : 0
        }
        ,
    ...
    var Xa = function(e) {
        ...
        t.prototype.render = function() {
            var e = this.props
              ...
              , a = {
                ...
                isDraggable: !e.disableDragging && nr(r, t),
                isStartResizable: !e.disableResizing && rr(r, t),
                isEndResizable: !e.disableResizing && or(r),
        ...
        ,
        t.prototype.componentDidMount = function() {
            Kn(this.elRef.current, this.props.seg)
        }
        ,
        t.prototype.componentDidUpdate = function(e) {
            var t = this.props.seg;
            t !== e.seg && Kn(this.elRef.current, t)
        }
        ,
        t
    }(Ao)
      , Ka = function(e) {
        ...
        t.prototype.render = function() {
            var e = this.props
              ...
              , i = ir(n, o, t, e.defaultDisplayEventTime, e.defaultDisplayEventEnd);
            return wo(Xa, {
                seg: n,
                timeText: i,
                disableDragging: e.disableDragging,
                disableResizing: e.disableResizing,
                defaultContent: e.defaultContent || $a,
                ...
                }, s), l.isStartResizable && wo("div", {
                    className: "fc-event-resizer fc-event-resizer-start"
                }), l.isEndResizable && wo("div", {
    ...
    function $a(e) {
        ...
        }, e.event.title || wo(To, null, " "))))
    }
    var Ja = function(e) {
        return wo(No.Consumer, null, (function(t) {
            var n = t.options
              , r = {
                isAxis: e.isAxis,
    ...
    function ts(e) {
        var t = e.date
          , n = e.dateEnv
          , o = to(t, e.todayRange, null, e.dateProfile);
        return r(r(r({
            date: n.toDate(t),
            view: e.viewApi
        }, o), {
            dayNumberText: e.showDayNumber ? n.format(t, Qa) : ""
        }), e.extraProps)
    }
    var ns = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.refineHookProps = Yt(ts),
            t.normalizeClassNames = Xo(),
            t
        }
        return n(t, e),
        t.prototype.render = function() {
            var e = this.props
              ...
              , o = no(r, t.theme).concat(r.isDisabled ? [] : this.normalizeClassNames(n.dayCellClassNames, r))
              , i = r.isDisabled ? {} : {
                "data-date": Bt(e.date)
            };
            return wo(Zo, {
    ...
    var ls = function(e) {
        ...
        t.prototype.updateSize = function() {
            var e = this.context.isRtl
              ...
              , o = this.rootEl
              , i = function(e) {
                for (var t = vo(e), n = e.getBoundingClientRect(), r = 0, o = t; r < o.length; r++) {
                    var i = Yr(n, o[r].getBoundingClientRect());
                    if (!i)
                        return null;
                    n = i
                }
      ...
      , cs = function(e) {
        ...
        t.prototype.render = function() {
            var e = this
              , t = this.props
              , n = this.state;
            return wo(No.Consumer, null, (function(r) {
                var o = r.viewApi
                  , i = r.options
                  , a = r.calendarApi
                  , s = i.moreLinkText
                ...
                return wo(To, null, Boolean(t.moreCnt) && wo(jo, {
                    elRef: e.linkElRef,
                    hookProps: p,
                    classNames: i.moreLinkClassNames,
                    content: i.moreLinkContent,
                    defaultContent: t.defaultContent || ds,
    ...
    function ps(e) {
        ...
        return {
            ...
            t.reduce(vs).eventRange.range.end)
        }
    }
    function fs(e) {
        return e.reduce(hs).eventRange.range.start
    }
    function hs(e, t) {
    ...
    var gs = function(e) {
        function t(t, n) {
            ...
            ,
            o.el = t,
            o.renderRunner = new wi(o.handleRenderRequest),
            new Ti({
                optionOverrides: n,
                calendarApi: o,
    ...
    var ms = 0
      ...
      , Ss = function() {
        function e(e) {
            ...
            1 === (ys += 1) && window.addEventListener("touchmove", bs, {
                passive: !1
            })
        }
        return e.prototype.destroy = function() {
            ...
            (ys -= 1) || window.removeEventListener("touchmove", bs, {
                passive: !1
            })
        }
        ,
    ...
    var Ds = function() {
        ...
        ,
        e.prototype.cleanup = function() {
            this.mirrorEl && (Ee(this.mirrorEl),
            this.mirrorEl = null),
            this.sourceEl = null
        }
        ,
      ...
      , ws = function(e) {
        function t(t, n) {
            return e.call(this, new So(t), n) || this
        }
        return n(t, e),
        ...
        t.prototype.computeClientRect = function() {
            return fo(this.scrollController.el)
        }
        ,
        t
    }(Cs)
      , Rs = function(e) {
        function t(t) {
            return e.call(this, new bo, t) || this
        }
        return n(t, e),
        t.prototype.getEventTarget = function() {
            return window
      ...
      , _s = "function" == typeof performance ? performance.now : Date.now
      , Ts = function() {
        function e() {
            var e = this;
            this.isEnabled = !0,
        ...
        e.prototype.buildCaches = function(e) {
            return this.queryScrollEls(e).map((function(e) {
                return e === window ? new Rs(!1) : new ws(e,!1)
            }
            ))
        }
        ,
      ...
      , xs = function() {
        function e(e) {
            this.origRect = ho(e),
            this.scrollCaches = vo(e).map((function(e) {
                return new ws(e,!0)
            }
            ))
        }
        ...
        e.prototype.isWithinClipping = function(e, t) {
            for (var n, r = {
                ...
                var a = i[o];
                if (void 0,
                "HTML" !== (n = a.getEventTarget().tagName) && "BODY" !== n && !qr(r, a.clientRect))
                    return !1
            }
            return !0
        }
      ...
      , Ms = function() {
        ...
        return e.prototype.processFirstCoord = function(e) {
            ...
            o instanceof HTMLElement && (r = Zr(r, t = ho(o)));
        ...
        e.prototype.handleMove = function(e, t) {
            ...
            !t && Is(this.movingHit, n) || (this.movingHit = n,
            ...
            for (var i in n) {
                ...
                if (s && s.isWithinClipping(e, t)) {
                    ...
                    if (c >= 0 && c < f && d >= 0 && d < h) {
                        ...
                        v && qn(v.dateProfile.activeRange, v.dateSpan.range) && (!o || v.layer > o.layer) && (v.componentId = i,
                        v.context = a.context,
                        v.rect.left += l,
                        v.rect.right += l,
                        v.rect.top += u,
    ...
    var Ns = function(e) {
        function t(t) {
            ...
            ,
            n.dragging = new ks(t.el),
            n.dragging.autoScroller.isEnabled = !1;
            var o = n.hitDragging = new Ms(n.dragging,Xi(t));
      ...
      , Os = function(e) {
        function t(n) {
            ...
            o.handlePointerDown = function(e) {
                ...
                var u = o.subjectSeg = $n(e.subjectEl)
                ...
                if (o.isDragging) {
                    ...
                    if (e) {
                        ...
                        i === a || d.editable && d.droppable ? (s = function(e, t, n) {
                            ...
                            o.allDay && (i = lt(i)));
                            var l = Vn(i, a, e.context.dateEnv, e.componentId === t.componentId ? e.largeUnit : null);
                            ...
                            for (var u = {
                                ...
                                d[c])(u, e, t);
                            return u
                        }(r, e, a.getCurrentData().pluginHooks.eventDragMutationMassagers)) && (l = Er(n, a.getCurrentData().eventUiBases, s, a),
                        c.mutatedEvents = l,
                        wa(c, e.dateProfile, a) || (u = !0,
                        s = null,
                        l = null,
                        c.mutatedEvents = {
                            defs: {},
            ...
            o.handleDragEnd = function(e) {
                if (o.isDragging) {
                    ...
                    s) {
                        if (a === t) {
                            var h = new kr(t,p.defs[l.defId],u ? p.instances[u.instanceId] : null);
                            t.dispatch({
                                type: "MERGE_EVENTS",
                                eventStore: p
                            });
      ...
      , As = function(e) {
        function t(t) {
            ...
            n.handleHitUpdate = function(e, t, r) {
                ...
                e && (e.componentId === a.componentId && n.isHitComboAllowed && !n.isHitComboAllowed(a, e) || (l = function(e, t, n, r) {
                    var o = e.context.dateEnv
                      , i = Vn(e.dateSpan.range.start, t.dateSpan.range.start, o, e.largeUnit);
                    if (n) {
                        if (o.add(r.start, i) < r.end)
                            return {
                                startDelta: i
                            }
                    } else if (o.add(r.end, i) > r.start)
                        return {
                            endDelta: i
                        };
                    return null
                }(a, e, r.subjectEl.classList.contains("fc-event-resizer-start"), s.range))),
                l && (u = Er(i, o.getCurrentData().eventUiBases, l, o),
                d.mutatedEvents = u,
                wa(d, e.dateProfile, o) || (c = !0,
                l = null,
                u = null,
            ...
            n.handleDragEnd = function(e) {
                ...
                n.validMutation) {
                    var u = new kr(t,l.defs[o.defId],i ? l.instances[i.instanceId] : null);
                    t.dispatch({
                        type: "MERGE_EVENTS",
                        eventStore: l
                    });
      ...
      , Ls = function() {
        function e(e) {
            ...
            this.onDocumentPointerDown = function(e) {
                ...
                t.matchesEvent = !!Se(r, Os.SELECTOR)
            }
            ,
        ...
        function e(e, t) {
            ...
            this.handleHitUpdate = function(e, t, o) {
                ...
                n.canDropElOnCalendar(o.subjectEl, a) && (s = function(e, t, n) {
                    ...
                    var l = Hn(o, n)
                      , u = An(l.refined, l.extra, t.sourceId, e.allDay, n.options.forceEventDuration || Boolean(t.duration), n)
                      , c = e.range.start;
                    e.allDay && t.startTime && (c = n.dateEnv.add(c, t.startTime));
                    var d = t.duration ? n.dateEnv.add(c, t.duration) : yr(e.allDay, c, n);
                    return {
                        def: u,
                        instance: mt(u.defId, {
                            start: c,
                ...
                (l = !wa(u, e.dateProfile, a)) && (u.mutatedEvents = {
                    defs: {},
                    instances: {}
                },
                s = null))),
                ...
                o && i) {
                    ...
                    l.create) {
                        ...
                        o.emitter.trigger("eventReceive", {
                            event: new kr(o,i.def,i.instance),
                            relatedEvents: [],
                            revert: function() {
                                o.dispatch({
                                    type: "REMOVE_EVENTS",
            ...
            ;
            var o = this.hitDragging = new Ms(e,Ki);
            o.requireInitial = !1,
    ...
    var Fs = function() {
        function e(e, t) {
            ...
            this.handlePointerDown = function(e) {
                var t = n.dragging
                  ...
                  , o = r.minDistance
                  , i = r.longPressDelay;
                t.minDistance = null != o ? o : e.isTouch ? 0 : cn.eventDragMinDistance,
      ...
      , js = Fo({
        componentInteractions: [Ns, Hs, Os, As],
        calendarInteractions: [Ls],
        elementDraggingImpl: ks,
        optionRefiners: Us,
        listenerRefiners: Ws
    })
      , Gs = function(e) {
    ...
    var Qs = function(e) {
      ...
      , el = function(e) {
        ...
        t.prototype.render = function() {
            var e = this.props
              , t = this.context
              , n = t.options.eventTimeFormat || $s
              , o = ir(e.seg, n, t, !0, e.defaultDisplayEventEnd);
            return wo(Xa, {
                seg: e.seg,
                timeText: o,
                defaultContent: tl,
        ...
        t.prototype.render = function() {
            ...
            return wo(cs, {
                ...
                popoverContent: function() {
                    ...
                    return wo(To, null, n.map((function(n) {
    ...
    var sl = function(e) {
      ...
      , ll = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.cellElRefs = new Ha,
            t.frameElRefs = new Ha,
            t.fgElRefs = new Ha,
            t.segHarnessRefs = new Ha,
            t.rootElRef = _o(),
            t.state = {
                framePositions: null,
        ...
        t.prototype.render = function() {
            var e = this
              ...
              , o = t.context.options
              , i = n.cells.length
              , a = Ys(n.businessHourSegs, i)
              , s = Ys(n.bgEventSegs, i)
              , l = Ys(this.getHighlightSegs(), i)
              , u = Ys(this.getMirrorSegs(), i)
            ...
            }(er(n.fgEventSegs, o.eventOrder), n.dayMaxEvents, n.dayMaxEventRows, o.eventOrderStrict, r.eventInstanceHeights, r.maxContentHeight, n.cells)
            ...
            return wo("tr", {
                ...
                return wo(il, {
                    ...
                    fgContent: wo(To, null, wo(To, null, o), wo(To, null, i)),
                    bgContent: wo(To, null, e.renderFillSegs(l[r], "highlight"), e.renderFillSegs(a[r], "non-business"), e.renderFillSegs(s[r], "bg-event"))
                })
            }
            )))
        }
            ...
            if (c)
                for (var h = 0, v = t; h < v.length; h++) {
                    var g = v[h]
                      ...
                      , C = "";
                    b && (l.isRtl ? (C = 0,
                    D = c.lefts[m.lastCol] - c.lefts[m.firstCol]) : (D = 0,
    ...
    var ul = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.splitBusinessHourSegs = qt(qs),
            t.splitBgEventSegs = qt(qs),
            t.splitFgEventSegs = qt(qs),
            t.splitDateSelectionSegs = qt(qs),
            t.splitEventDrag = qt(Zs),
            t.splitEventResize = qt(Zs),
            t.rowRefs = new Ha,
            t.handleRootEl = function(e) {
                t.rootEl = e,
                e ? t.context.registerInteractiveComponent(t, {
        ...
        ,
        t.prototype.prepareHits = function() {
            this.rowPositions = new yo(this.rootEl,this.rowRefs.collect().map((function(e) {
                return e.getCellEls()[0]
            }
            )),!1,!0),
            this.colPositions = new yo(this.rootEl,this.rowRefs.currentMap[0].getCellEls(),!0,!1)
        }
        ,
    ...
    var dl = function(e) {
      ...
      , fl = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.buildDayTableModel = qt(hl),
            t.headerRef = _o(),
            t.tableRef = _o(),
            t
        }
    ...
    function hl(e, t) {
        var n = new Sa(e.renderRange,t);
        return new ba(n,/year|month|week/.test(e.currentRangeUnit))
    }
    var vl = Fo({
            ...
            dayGrid: {
                ...
                dateProfileGeneratorClass: function(e) {
                    ...
                    t.prototype.buildRenderRange = function(t, n, r) {
                        ...
                        return /^(year|month)$/.test(n) && (s = i.startOfWeek(s),
                        (o = i.startOfWeek(l)).valueOf() !== l.valueOf() && (l = et(o, 1))),
      ...
      , gl = function(e) {
        ...
        t.prototype.getKeysForEventDef = function(e) {
            return e.allDay ? Xn(e) ? ["timed", "allDay"] : ["allDay"] : ["timed"]
        }
        ,
        t
    }(Qr)
    ...
    function yl(e) {
        ...
        return wo(No.Consumer, null, (function(n) {
            ...
            var r = n.dateEnv
              , o = n.options
              , i = n.viewApi
              , a = null == o.slotLabelFormat ? ml : Array.isArray(o.slotLabelFormat) ? ln(o.slotLabelFormat[0]) : ln(o.slotLabelFormat)
              , s = {
                level: 0,
                time: e.time,
    ...
    var Sl = function(e) {
      ...
      , Dl = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.allDaySplitter = new gl,
            t.headerElRef = _o(),
            t.rootElRef = _o(),
            t.scrollerElRef = _o(),
            t.state = {
            ...
            t.renderHeadAxis = function(e, n) {
                ...
                var o = t.context.options
                  ...
                  , a = 1 === ot(i.start, i.end) ? io(t.context, i.start, "week") : {};
                return o.weekNumbers && "day" === e ? wo(as, {
                    date: i.start,
                    defaultFormat: bl
                }, (function(e, t, o, i) {
                    return wo("th", {
            ...
            return f.push({
                ...
                chunks: [{
                    ...
                    content: function(e) {
                        ...
                        }, e.tableColGroupNode, wo("tbody", null, wo(Sl, {
                            slatMetas: i
                        }))), wo("div", {
    ...
    var wl = function() {
        ...
        e.prototype.computeDateTop = function(e, t) {
            return t || (t = lt(e)),
            this.computeTimeTop(Nt(e.valueOf() - t.valueOf()))
        }
        ,
      ...
      , Rl = function(e) {
        ...
        t.prototype.render = function() {
            var e = this.props
              ...
              , n = t.options
              , o = e.slatElRefs;
            return wo("tbody", null, e.slatMetas.map((function(i, a) {
                var s = {
                    time: i.time,
      ...
      , _l = function(e) {
        ...
        t.prototype.updateSizing = function() {
            ...
            n.onCoords && null !== n.clientWidth && this.rootElRef.current.offsetHeight && n.onCoords(new wl(new yo(this.rootElRef.current,(e = this.slatElRefs.currentMap,
    ...
    function Il(e, t, n) {
        ...
        var i, a, s = Bi(o.addSegs(e)), l = function(e) {
              ...
              , n = Ol((function(e, t) {
                ...
                var a = Pl(function(e, t, n) {
                    for (var r = e.levelCoords, o = e.entriesByLevel, i = o[t][n], a = r[t] + i.thickness, s = r.length, l = t; l < s && r[l] < a; l += 1)
                        ;
                    for (; l < s; l += 1) {
                        for (var u = o[l], c = void 0, d = qi(u, i.span.start, Vi), p = d[0] + d[1], f = p; (c = u[f]) && c.span.start < i.span.end; )
                            f += 1;
                        if (p < f)
                            return {
                                level: l,
        ...
        a = Ol((function(e, t, n) {
            ...
            var o, i = e.nextLevelNodes, s = e.thickness, l = s + n, u = s / l, c = [];
            if (i.length)
      ...
      , Vl = function(e) {
        ...
        t.prototype.render = function() {
            ...
            return wo(ns, {
                ...
                }, u, t.extraDataAttrs), wo("div", {
                    className: "fc-timegrid-col-frame"
                }, wo("div", {
                    className: "fc-timegrid-col-bg"
                }, e.renderFillSegs(t.businessHourSegs, "non-business"), e.renderFillSegs(t.bgEventSegs, "bg-event"), e.renderFillSegs(t.dateSelectionSegs, "highlight")), wo("div", {
                    className: "fc-timegrid-col-events"
                }, e.renderFgSegs(s, a, !1, !1, !1)), wo("div", {
                    className: "fc-timegrid-col-events"
                }, e.renderFgSegs(i, {}, Boolean(t.eventDrag), Boolean(t.eventResize), Boolean(o))), wo("div", {
                    className: "fc-timegrid-now-indicator-container"
                }, e.renderNowIndicator(t.nowIndicatorSegs)), wo(Wl, {
                    date: t.date,
                    dateProfile: t.dateProfile,
                    todayRange: t.todayRange,
                    extraHookProps: t.extraHookProps
        ...
        t.prototype.renderPositionedFgSegs = function(e, t, n, o, i) {
            var a = this
              ...
              , E = function(e, t, n, r) {
                ...
                for (var l = Il(o, n, r), u = l.segRects, c = l.hiddenGroups, d = [], p = 0, f = u; p < f.length; p++) {
                    var h = f[p];
                    d.push({
                        seg: e[h.index],
                        rect: h
              ...
              , S = E.segPlacements
              , b = E.hiddenGroups;
            return wo(To, null, this.renderHiddenGroups(b, e), S.map((function(e) {
                var s = e.seg
                  , l = e.rect
        ...
        t.prototype.renderHiddenGroups = function(e, t) {
            var n = this.props
              ...
              , l = n.eventDrag
              , u = n.eventResize;
            return wo(To, null, e.map((function(e) {
                var n, c, d = Bl(e.span), p = (n = e.entries,
                c = t,
                n.map((function(e) {
                    return c[e.index]
                }
            ...
            var n = this.props
              ...
              , i = Al(e, n.date, n.slatCoords, o.options.eventMinHeight).map((function(o, i) {
                ...
                return wo("div", {
                    ...
                    seg: a
                }, ar(a, n.todayRange, n.nowDate))) : rs(t))
            }
            ));
            return wo(To, null, i)
        }
    ...
    var zl = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.splitFgEventSegs = qt(Tl),
            t.splitBgEventSegs = qt(Tl),
            t.splitBusinessHourSegs = qt(Tl),
            t.splitNowIndicatorSegs = qt(Tl),
            t.splitDateSelectionSegs = qt(Tl),
            t.splitEventDrag = qt(kl),
            t.splitEventResize = qt(kl),
            t.rootElRef = _o(),
            t.cellElRefs = new Ha,
            t
        }
        ...
        t.prototype.updateCoords = function() {
            var e, t = this.props;
            t.onColCoords && null !== t.clientWidth && t.onColCoords(new yo(this.rootElRef.current,(e = this.cellElRefs.currentMap,
      ...
      , jl = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.processSlotOptions = qt(Gl),
            t.state = {
                slatCoords: null
            },
            t.handleRootEl = function(e) {
    ...
    function Kl(e, t, n, r, o) {
        for (var i = new Date(0), a = e, s = Nt(0), l = n || function(e) {
            var t, n, r;
            for (t = Xl.length - 1; t >= 0; t -= 1)
                if (null !== (r = Wt(n = Nt(Xl[t]), e)) && r > 1)
                    return n;
            return e
        }(r), u = []; Ut(a) < Ut(t); ) {
            var c = o.add(i, a)
    ...
    var $l = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.buildTimeColsModel = qt(Jl),
            t.buildSlatMetas = qt(Kl),
            t
        }
        return n(t, e),
        t.prototype.render = function() {
        ...
        t.prototype.render = function() {
            var e = this.context
              ...
              , h = r({
                ...
                text: p,
                sideText: f,
                navLinkAttrs: io(this.context, l),
                sideNavLinkAttrs: io(this.context, l, "day", !1)
            }, d)
              , v = ["fc-list-day"].concat(no(d, t));
            return wo(jo, {
                hookProps: h,
    ...
    function tu(e) {
        return wo(To, null, e.text && wo("a", r({
            id: e.textId,
            className: "fc-list-day-text"
        }, e.navLinkAttrs), e.text), e.sideText && wo("a", r({
            "aria-hidden": !0,
      ...
      , ru = function(e) {
        ...
        t.prototype.render = function() {
            var e = this.props
              ...
              , i = e.eventHeaderId
              , a = e.dateHeaderId
              , s = t.options.eventTimeFormat || nu;
            return wo(Xa, {
                seg: n,
                timeText: "",
                disableDragging: !0,
                ...
                defaultContent: function() {
                    return function(e, t) {
                        var n = ur(e, t);
                        return wo("a", r({}, n), e.eventRange.def.title)
                    }(n, t)
                },
                isPast: e.isPast,
                isFuture: e.isFuture,
                ...
                return wo("tr", {
                    ...
                    if (!1 !== i.displayEventTime) {
                        var a = e.eventRange.def
                          ...
                          , l = !1
                          , u = void 0;
                        if (a.allDay ? l = !0 : Wn(e.eventRange.range) ? e.isStart ? u = ir(e, t, n, null, null, s.range.start, e.end) : e.isEnd ? u = ir(e, t, n, null, null, e.start, s.range.end) : l = !0 : u = ir(e, t, n),
                        l) {
                            var c = {
    ...
    var iu = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.computeDateVars = qt(su),
        ...
        t.prototype.renderSegList = function(e, t) {
            ...
            return wo(ga, {
                ...
                return wo("table", {
                ...
                }, wo("thead", null, wo("tr", null, wo("th", {
                    scope: "col",
                    id: s
                }, i.timeHint), wo("th", {
                    scope: "col",
                    ...
                    scope: "col",
                    id: l
                }, i.eventHint))), wo("tbody", null, a))
            }
            ))
        }
        ,
        t.prototype._eventStoreToSegs = function(e, t, n) {
            return this.eventRangesToSegs(Zn(e, t, this.props.dateProfile.activeRange, this.context.options.nextDayThreshold).fg, n)
        }
        ,
            ...
            fetch: function(e, t, n) {
                ...
                if (l) {
                    var u = function(e) {
                        ...
                        return t || (t = "https://www.googleapis.com/calendar/v3/calendars"),
                      ...
                      , p = function(e, t, n, o) {
                        var i, a, s;
                        return o.canComputeOffset ? (a = o.formatIso(e.start),
                        s = o.formatIso(e.end)) : (a = tt(e.start, -1).toISOString(),
    ...
    return Ci.push(js, vl, Ql, uu, du, pu),
    ...
    e.CalendarDataManager = Ti,
    e.CalendarDataProvider = Ui,
    e.CalendarRoot = ua,
    e.Component = Co,
    e.ContentHook = qo,
    e.CustomContentRenderContext = Go,
    e.DateComponent = Vo,
    e.DateEnv = Or,
    ...
    e.Draggable = Fs,
    e.ElementDragging = $i,
    e.ElementScrollController = So,
    e.Emitter = mo,
    e.EventApi = kr,
    e.EventRoot = Xa,
    e.EventSourceApi = ye,
    e.FeaturefulElementDragging = ks,
    e.Fragment = To,
    e.Interaction = Yi,
    e.ListView = iu,
    e.MoreLinkRoot = cs,
    ...
    ,
    e.NowIndicatorRoot = Ja,
    e.NowTimer = ga,
    e.PointerDragging = Ss,
    e.PositionCache = yo,
    e.RefMap = Ha,
    e.RenderHook = jo,
    e.ScrollController = Eo,
    e.ScrollResponder = Po,
    e.Scroller = Na,
    e.SegHierarchy = Wi,
    e.SimpleScrollGrid = Za,
    e.Slicer = Da,
    e.Splitter = Qr,
    e.StandardEvent = Ka,
    e.Table = ul,
    ...
    e.TimeColsView = Dl,
    e.ViewApi = Dr,
    e.ViewContextType = No,
    e.ViewRoot = Jo,
    e.WeekNumberRoot = as,
    e.WindowScrollController = bo,
    e.addDays = tt,
    e.addDurations = Ot,
    e.addMs = nt,
    e.addWeeks = et,
    ...
    e.allowSelection = Fe,
    e.applyMutationToEventStore = Er,
    e.applyStyle = we,
    e.applyStyleProp = Re,
    ...
    ,
    e.binarySearch = qi,
    e.buildClassNameNormalizer = Xo,
    e.buildDayRanges = Zl,
    e.buildDayTableModel = hl,
    e.buildEntryKey = Fi,
    e.buildEventApis = Mr,
    e.buildEventRangeKey = lr,
    ...
    ,
    e.buildIsoString = Ft,
    e.buildNavLinkAttrs = io,
    e.buildSegCompareObj = tr,
    e.buildSegTimeText = ir,
    e.buildSlatMetas = Kl,
    e.buildTimeColsModel = Jl,
    e.collectFromHash = kt,
    e.combineEventUis = kn,
    e.compareByFieldSpec = qe,
    e.compareByFieldSpecs = Ge,
    e.compareNumbers = Ke,
    e.compareObjs = _t,
    e.computeEarliestSegStart = fs,
    e.computeEdges = po,
    ...
    ,
    e.computeInnerRect = fo,
    e.computeRect = ho,
    e.computeSegDraggable = nr,
    e.computeSegEndResizable = or,
    e.computeSegStartResizable = rr,
    e.computeShrinkWidth = Oa,
    e.computeSmallestCellWidth = Je,
    e.computeVisibleDayRange = Un,
    e.config = Ji,
    e.constrainPoint = Zr,
    ...
    ,
    e.getAllowYScrolling = La,
    e.getCanVGrowWithinCell = $r,
    e.getClippingParents = vo,
    e.getDateMeta = to,
    e.getDayClassNames = no,
    e.getDefaultEventEnd = yr,
    e.getElRoot = Te,
    e.getElSeg = $n,
    e.getEntrySpanEnd = Vi,
    e.getEventClassNames = sr,
    e.getEventTargetViaRoot = _e,
    e.getIsRtlScrollbarOnLeft = lo,
    e.getRectCenter = Xr,
    e.getRelevantEvents = bn,
    e.getScrollGridClassNames = za,
    e.getScrollbarWidths = uo,
    e.getSectionClassNames = ja,
    e.getSectionHasLiquidHeight = Aa,
    e.getSegAnchorAttrs = ur,
    e.getSegMeta = ar,
    ...
    e.intersectRanges = zn,
    e.intersectRects = Yr,
    e.intersectSpans = ji,
    e.isArraysEqual = Gt,
    e.isColPropsEqual = Wa,
    e.isDateSelectionValid = Ra,
    e.isDateSpansEqual = pr,
    e.isInt = $e,
    e.isInteractionValid = wa,
    e.isMultiDayRange = Wn,
    e.isPropsEqual = wt,
    e.isPropsValid = Ta,
    e.isValidDate = vt,
    e.joinSpans = zi,
    ...
    ,
    e.memoizeObjArg = Yt,
    e.mergeEventStores = Dn,
    e.multiplyDuration = At,
    e.padStart = Ze,
    e.parseBusinessHours = Gr,
    e.parseClassNames = wn,
    e.parseDragMeta = ea,
    e.parseEventDef = An,
    e.parseFieldSpecs = je,
    e.parseMarker = Hr,
    e.pointInsideRect = qr,
    e.preventContextMenu = Be,
    e.preventDefault = Me,
    e.preventSelection = Ve,
    e.rangeContainsMarker = Yn,
    e.rangeContainsRange = qn,
    e.rangesEqual = jn,
    e.rangesIntersect = Gn,
    e.refineEventDef = Hn,
    e.refineProps = mn,
    e.removeElement = Ee,
    ...
    e.renderFill = rs,
    e.renderMicroColGroup = Va,
    e.renderScrollShim = Ga,
    e.requestJson = Si,
    e.sanitizeShrinkWidth = Fa,
    e.setElSeg = Kn,
    e.setRef = Wo,
    e.sliceEventStore = Zn,
    e.sliceEvents = function(e, t) {
        return Zn(e.eventStore, e.eventUiBases, e.dateProfile.activeRange, t ? e.nextDayThreshold : null).fg
    }
    ,
    e.sortEventSegs = er,
    e.startOfDay = lt,
    ...
    ,
    e.triggerDateSelect = gr,
    e.unmountComponentAtNode = Io,
    e.unpromisify = go,
    e.version = "5.10.1",
