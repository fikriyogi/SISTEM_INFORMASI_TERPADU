...
!function(l, o) {
    ...
    l.Message = function() {
        ...
        function s(s) {
            ...
            r.addClass("visible"),
            h.addClass(u),
            !0 === s && d.addClass("msg-" + u)
        }
        function a(s) {
            n.removeClass("active"),
            r.removeClass("visible"),
            h.removeClass(u),
            !0 === s && d.removeClass("msg-" + u)
        }
        function i() {
            var s = "." + f;
        ...
        t.on("resize", function() {
            d.hasClass("msg-profile-autohide") && (l.Win.width >= v ? s : a)(),
            l.Win.width >= c && l.Win.width < v && d.hasClass("msg-" + u) && (d.removeClass("msg-" + u),
            a()),
            i()
        })
    }
