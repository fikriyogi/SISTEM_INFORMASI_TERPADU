                        ...
                        <div class="nk-block-head nk-block-head-sm">
                            <div class="nk-block-between">
                                <div class="nk-block-head-content">
                                    <h3 class="nk-block-title page-title">Perangkat Desa</h3>
                                ...
                                <div class="card-inner-group">
                                    ...
                                    <div class="card-inner p-0">
                                        <div class="nk-tb-list nk-tb-ulist">
                                            ...
                                            <?php
                                            $id = $_SESSION['app_id'];
                                            $data = $user_home->runQuery("SELECT * FROM ds_perangkat_desa, warga WHERE ds_perangkat_desa.desa_id=? AND warga.nik=ds_perangkat_desa.nik_id");
                                            $data->execute([$_SESSION['app_id']]);
                                            $a = $data->fetchAll();
                                            foreach ($a as $row) {
                                            echo
