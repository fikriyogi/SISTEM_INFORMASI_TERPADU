...
if (isset($_POST['send'])) {
    ...
    $stmt = $user_home->runQuery("INSERT INTO tb_notice(uid,title,date_note,notice,create_at,nik_id) VALUES(?,?,?,?,?,?)");
    $stmt->execute([$code, $title, $tanggal, $note, $create_at,$_GET['uid']]);
                                            ...
                                            <div class="tab-pane active" id="tabItem1">
                                                ...
                                                <div class="nk-block">
                                                    <div class="nk-block-head nk-block-head-sm nk-block-between">
                                                        ...
                                                        <a href="#" class="link link-sm"  data-toggle="modal" data-target="#add-notice">+ Add Note</a>
                                                    </div>
                                                    <div class="bq-note">
...
<div class="modal fade" role="dialog" id="add-notice">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">Tambah note</h6>
                    ...
                    <div class="card-inner">
                        <form action="#" class="form-validate">
                            <div class="row g-gs">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label" for="fv-message">Catatan</label>
                                        <div class="form-control-wrap">
                                            <textarea class="form-control form-control-sm" id="fv-message" name="note" placeholder="Write your message" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
