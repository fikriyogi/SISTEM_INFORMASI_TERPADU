...
$data = $user_home->runQuery("SELECT * FROM tb_terms");
$data->execute();
$a = $data->fetchAll();
            ...
            <div class="col-md-12">
                <table class="table table-bordered" width="90%">
                    ...
                    foreach($a as $row)
                    {
                        echo "<tr>";
                        echo "<td>".$no."</td>";
                        echo "<td>".$row['id_terms']."</td>";
                        echo "<td><a class='btn btn-info' href='profil-penduduk.php?id=".$row['id_terms']."'>".$row['judul']."</a></td>";
                        echo "<td>".$row['deskripsi']."</td>";
                        echo "<td>".$row['status']."</td>";
                        echo "<td><a class='btn btn-info' href='students.php?appKey=".$row['deskripsi']."'>Siswa</a> | <a class='btn btn-info' href='update-tps.php?id=".$row['id_terms']."'>TPS</a> |
                        <a class='btn btn-danger' href='penduduk.php?hapus_siswa=".$row['id_terms']."' onclick='return confirm(".'Are you sure'.")'>Hapus</a></td>";
                        echo "</tr>";
                        $no++;
                    }
                    ?>
