                        ...
                        <div class="nk-block-head nk-block-head-sm">
                            <div class="nk-block-between">
                                <div class="nk-block-head-content">
                                    <h3 class="nk-block-title page-title"><?php echo $menu; ?></h3>
                                            ...
                                            <div class="card-inner">
                                                <div class="card-title-group">
                                                    <div class="card-title">
                                                        <h6 class="title">Total Pasien</h6>
                                                    </div>
                                                </div>
                                                <div class="data">
                                                    <div class="data-group">
                                                        <div class="amount"><?php echo $user_home->count('rs_pasien','rs_id',$_SESSION['app_id']); ?></div>
                                    ...
                                    <div class="card">
                                        <div class="nk-ecwg nk-ecwg6">
                                            <div class="card-inner">
                                                <div class="card-title-group">
                                                    <div class="card-title">
                                                        <h6 class="title">Pasien Hari Ini</h6>
                                                    </div>
                                                </div>
                                                <div class="data">
                                                    <div class="data-group">
                                    ...
                                    <div class="card">
                                        <div class="nk-ecwg nk-ecwg6">
                                            <div class="card-inner">
                                                <div class="card-title-group">
                                                    <div class="card-title ">
                                                        <h6 class="title">Pasien Minggu Ini</h6>
                                                    </div>
                                                </div>
                                                <div class="data">
                                                    <div class="data-group">
                                                        <div class="amount"><?php 
                                                        echo $user_home->sql_count('SELECT YEARWEEK(tgl_masuk),COUNT(*)
FROM rs_pasien
WHERE YEARWEEK(tgl_masuk)=YEARWEEK(NOW())
GROUP BY YEARWEEK(tgl_masuk)');
